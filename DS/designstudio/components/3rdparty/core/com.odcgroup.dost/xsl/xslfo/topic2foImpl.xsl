...
<xsl:transform version="1.0" xmlns:fo="http://www.w3.org/1999/XSL/Format"
  ...
  <xsl:import href="../../dost/xsl/common/output-message.xsl"/>
  ...
  <xsl:param name="body.font.size">18pt</xsl:param>
  ...
  <!-- common routines -->
  <xsl:include href="../../dost/xsl/common/dita-utilities.xsl"/>
...
-->
 ...
 +-->
  ...
  <xsl:template name="gen-user-header">
    ...
    <fo:block line-height="140%" font-weight="bold" font-size="20pt">XXXXXXXXX</fo:block>
  </xsl:template>
  ...
  <xsl:template name="chapter-setup">
    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
      ...
      <fo:page-sequence master-reference="common-page" force-page-count="no-force">
        <!-- header -->
				<!-- XXX Try to remove the emty page before content -->
				<!--
