...
public class MacrosTemplatesActionDelegate implements IWorkbenchWindowActionDelegate {
    ...
    public void run(IAction action) {
        ...
        try {           
           page.showView((new MacrosView().getViewID()));
           page.showView((new TemplatesView().getViewID()));
        }
