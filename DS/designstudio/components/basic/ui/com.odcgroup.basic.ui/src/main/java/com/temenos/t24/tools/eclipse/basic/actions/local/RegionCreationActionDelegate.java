...
public class RegionCreationActionDelegate implements IWorkbenchWindowActionDelegate {
    ...
    public void run(IAction action) {
        ...
        CreateRegionDialog dialog = new CreateRegionDialog(window.getShell(), "Region dialog");
    ...
    private void createGosubRegion(CreateRegionDialog dialog) {
        ...
        cr.createRegion(editor,doc,dialog.getRegionName(), dialog.getRegionDescription());  
