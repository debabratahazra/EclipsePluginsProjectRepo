 ...
 */
public class ActionEmptyAction extends AbstractAction {
    ...
    public Response processAction(String[] args) {
        ...
        Command cmd = buildCommand(sessionToken);
    ...
    */
    public Command buildCommand(String sessionToken){
        Command cmd = new Command(ProtocolConstants.COMMAND_EMPTY_ACTION);
        cmd.setBody(buildCommandBody(sessionToken));
        return cmd;
    }
     ...
     * @return
     */
    public String buildCommandBody(String tokenString){
        String header = ActionCommon.getCommandHeader();
        Document dom = DocumentHelper.createDocument();
        buildCommonCommandBody(dom, tokenString);
