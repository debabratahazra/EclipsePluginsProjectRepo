package com.temenos.t24.tools.eclipse.basic.views.inserts;
...
/**
 * View to show the $INSERTs made within the active editor.
 */
public class InsertsView extends ViewPart implements IT24View {
    // The following ID is the one defined in the plugin manifest for this View
    public static final String VIEW_ID = "com.temenos.t24.tools.eclipse.basic.viewInserts";
    private TableViewer tableViewer;
    private ISelectionListener pageSelectionListener;
    private IEditorPart curActiveEditor;
    private ViewCommon viewCommon;
    private T24_VIEW_ITEM_CATEGORY itemCategory  = T24_VIEW_ITEM_CATEGORY.INSERT_ITEM;    
    ...
    private void createTableViewer(Composite parent) {
        // INSTANCIATE VIEWER
        String[] columnNames = {"Insert Statements"};
