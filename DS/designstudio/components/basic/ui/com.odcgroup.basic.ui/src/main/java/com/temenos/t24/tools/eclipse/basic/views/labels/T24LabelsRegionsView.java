package com.temenos.t24.tools.eclipse.basic.views.labels;
...
/**
 * View to show the labels and regions within the active editor.
 */
public class T24LabelsRegionsView extends ViewPart implements IT24View {
    // The following ID is the one defined in the plugin manifest for this View
    public static final String VIEW_ID = "com.temenos.t24.tools.eclipse.basic.viewLabelsRegions";
    private TableViewer tableViewer;
    private ISelectionListener pageSelectionListener;
    private IEditorPart curActiveEditor;
    private ViewCommon viewCommon;
    private T24_VIEW_ITEM_CATEGORY itemCategory  = T24_VIEW_ITEM_CATEGORY.LABEL_AND_T24REGION_ITEM;    
    
    public T24LabelsRegionsView() {
    ...
    private void createTableViewer(Composite parent) {
        // INSTANCIATE VIEWER
        String[] columnNames = {"Labels/Regions"};
