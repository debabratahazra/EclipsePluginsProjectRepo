package com.temenos.t24.tools.eclipse.basic.views.todo;
...
/**
 */
public class TodoView extends ViewPart implements IT24View {
    // The following ID is the one defined in the plugin manifest for this View
    public static final String VIEW_ID = "com.temenos.t24.tools.eclipse.basic.viewTodo";
    private TableViewer tableViewer;
    private ISelectionListener pageSelectionListener;
    private IEditorPart curActiveEditor;
    private ViewCommon viewCommon;
    private T24_VIEW_ITEM_CATEGORY itemCategory  = T24_VIEW_ITEM_CATEGORY.TODO_ITEM;    
    ...
    private void createTableViewer(Composite parent) {
        // INSTANCIATE VIEWER
        String[] columnNames = {"Todo List"};
        int[] columnWidths   = {500};
