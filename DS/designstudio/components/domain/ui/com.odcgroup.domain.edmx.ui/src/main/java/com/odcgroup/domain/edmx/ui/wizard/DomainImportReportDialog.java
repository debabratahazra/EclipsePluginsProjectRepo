...
public class DomainImportReportDialog extends TitleAreaDialog {
	...
	protected void configureShell(Shell shell) {
		...
		String text = EDMXUICore.getDefault().getString(EDMXConstants.EDMX_WIZARD_IMPORT_REPORT_DIALOG_TITLE);
		shell.setText(NLS.bind(text, this.modelName));
	...
	public void create() {
		super.create();
		String text = EDMXUICore.getDefault().getString(EDMXConstants.EDMX_WIZARD_IMPORT_REPORT_DIALOG_TITLE);
		setTitle(NLS.bind(text, this.modelName));
	}
	
	public DomainImportReportDialog(Shell shell, EDMXImportReport report, String modelName) {
		super(shell);
