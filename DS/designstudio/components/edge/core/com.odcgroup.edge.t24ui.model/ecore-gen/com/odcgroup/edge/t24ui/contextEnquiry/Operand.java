...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Operand</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.odcgroup.edge.t24ui.contextEnquiry.ContextEnquiryPackage#getOperand()
 * @model
 * @generated
 */
public enum Operand implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Operand</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final Operand[] VALUES_ARRAY =
		new Operand[] {
			NONE,
			EQUALS,
			NOT_EQUALS,
	...
	/**
	 * A public read-only list of all the '<em><b>Operand</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<Operand> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Operand</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static Operand get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Operand result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Operand</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Operand</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static Operand get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private Operand(int value, String name, String literal) {
		this.value = value;
		this.name = name;
