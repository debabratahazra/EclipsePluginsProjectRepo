...
/**
 * Manages the installation/de-installation of global actions for Event
 ...
 * 
 */
public class EventsEditorContributor extends EditorActionBarContributor {

	/** holding the active editor */
	private IEditorPart activeEditorPart;

	public EventsEditorContributor() {
		super();
	}
	 ...
	 * @param actionBars
	 */
	private void hookGlobalTextActions(EventsEditor editor,
	...
	public void setActivePage(IEditorPart part) {
		EventsEditor editor = (EventsEditor) part;
		if (editor == null) {
			return;
		}
