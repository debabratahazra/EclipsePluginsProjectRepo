...
public class verCustomer_Create_IAuthResourceState extends ResourceState implements LazyResourceLoader {
    
    private ResourceFactory factory = null;

    public verCustomer_Create_IAuthResourceState() {
        this(new ResourceFactory());
    }

    public verCustomer_Create_IAuthResourceState(ResourceFactory factory) {
        super("verCustomer_Create", "verCustomer_Create_IAuth", createActions(), "/{companyid}/verCustomer_Creates_IAuth('{id}')", createLinkRelations(), new UriSpecification("verCustomer_Create_IAuth", "/{companyid}/verCustomer_Creates_IAuth('{id}')"), null);
    ...
    public boolean initialise() {
        ...
        ResourceState sverCustomer_Create_IAuth = this;
        // create transitions
        ...
        // create EMBEDDED transition
            ...
            sverCustomer_Create_IAuth.addTransition(new Transition.Builder()
    ...
    private static List<Action> createActions() {
        ...
        List<Action> verCustomer_Create_IAuthActions = new ArrayList<Action>();
        return verCustomer_Create_IAuthActions;
    }

    private static String[] createLinkRelations() {
        String[] verCustomer_Create_IAuthRelations = null;
        return verCustomer_Create_IAuthRelations;
    }
