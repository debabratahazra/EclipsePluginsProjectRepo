...
public class DebugServerActionTest  {
	...
	public void testStartWhenStopped() {
		...
		DebugServerAction action = new DebugServerAction(null, ServerActionTestHelper.newMockSelectionProvider()) {
			@Override
		...
		Assert.assertEquals(1, mockContibutions.startInDebugCalled);
	}
