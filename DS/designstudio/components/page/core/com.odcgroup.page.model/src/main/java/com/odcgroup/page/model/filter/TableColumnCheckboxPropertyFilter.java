...
/**
 */
public class TableColumnCheckboxPropertyFilter implements PropertyFilter {
	...
	public List<Property> filter(Widget widget) {
		...
		allowedTypes.remove(mm.findPropertyType(library, PropertyTypeConstants.SELECTED));
