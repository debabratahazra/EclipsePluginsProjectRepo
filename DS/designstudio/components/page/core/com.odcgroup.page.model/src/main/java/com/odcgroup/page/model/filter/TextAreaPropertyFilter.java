...
/**
 * Property Fileter calss for the TextArea Widget
 * @author snn
 *
 */
public class TextAreaPropertyFilter implements PropertyFilter {
    ...
    private String[] filterPropertys={PropertyTypeConstants.PREVIEW_VALUE,
            ...
            PropertyTypeConstants.ROWS,
            PropertyTypeConstants.WIDGET_GROUP,
            PropertyTypeConstants.RICHTEXT
