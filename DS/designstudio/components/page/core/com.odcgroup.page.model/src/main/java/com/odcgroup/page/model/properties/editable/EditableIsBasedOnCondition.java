package com.odcgroup.page.model.properties.editable;
...
/**
 * Represents the a simplified or advanced condition for the "Editable is based on"
 * condition
 * @author scn
 */
public class EditableIsBasedOnCondition {
	 ...
	 */
	public EditableIsBasedOnCondition(boolean simplified, MdfName simplifiedCondition, String advancedCondition) {
	 ...
	 * @param widget 
	 */
	public EditableIsBasedOnCondition(Widget widget) {
		Property editableIsBasedOn = widget.findProperty(EditableConstants.EDITABLE_IS_BASE_ON_PROPERTY_NAME);
		if (editableIsBasedOn != null) {
			this.simplified = !ADVANCED_VALUE.equals(editableIsBasedOn.getValue());
		} else {
			this.simplified = true;
		}

		Property simplifedProperty = widget.findProperty(EditableConstants.EDITABLE_IS_BASE_ON_SIMPLIFED_PROPERTY_NAME);
		...
		Property advancedProperty = widget.findProperty(EditableConstants.EDITABLE_IS_BASE_ON_ADVANCED_PROPERTY_NAME);
