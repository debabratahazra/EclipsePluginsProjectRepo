...
/**
 * Transformer used to generate enabled attribute value based on condition. 
 * Delegate to DefaultPropertyTransformerImpl for true/false values. 
 * @author yan
 * @since 2.4
 */
public class EnabledPropertyTransformer extends BasePropertyTransformer {
	...
	/**
	 * Construct a new EnabledPropertyTransformer
	 * @param type
	 */
	public EnabledPropertyTransformer(PropertyType type) {
		super(type);
	}
	...
	public void transform(WidgetTransformerContext context, Property property) throws CoreException {
		if (EnabledConstants.ENABLED_CONDITIONAL_VALUE.equals(property.getValue())) {
	        ...
	        xspAttribute.setAttribute(XSPConstants.XSP_NAME, EnabledConstants.ENABLED_PROPERTY_NAME);
