 ...
 *
 */
public class TableColumnCheckWidgetTransformer  extends TableColumnEditableItemWidgetTransformer {
	...
	protected Element performTransformation(WidgetTransformerContext context, Widget widget) throws CoreException {
		try {
			...
			WidgetType wt = widget.getLibrary().findWidgetType(WidgetTypeConstants.CHECKBOX);
	 ...
	 * @param type
	 */
	public TableColumnCheckWidgetTransformer(WidgetType type) {
