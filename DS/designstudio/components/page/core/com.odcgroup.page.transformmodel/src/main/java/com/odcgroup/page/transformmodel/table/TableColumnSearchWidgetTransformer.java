 ...
 *
 */
public class TableColumnSearchWidgetTransformer  extends TableColumnEditableItemWidgetTransformer {
	...
	protected Element performTransformation(WidgetTransformerContext context, Widget widget) throws CoreException {
		try {
			...
			WidgetType wt = widget.getLibrary().findWidgetType(WidgetTypeConstants.SEARCH_FIELD);
	 ...
	 * @param type
	 */
	public TableColumnSearchWidgetTransformer(WidgetType type) {
