 ...
 *
 */
public class TableColumnTextAreaWidgetTransformer  extends TableColumnEditableItemWidgetTransformer {
	...
	protected Element performTransformation(WidgetTransformerContext context, Widget widget) throws CoreException {
		try {
			...
			WidgetType wt = widget.getLibrary().findWidgetType(WidgetTypeConstants.TEXTAREA);
	 ...
	 * @param type
	 */
	public TableColumnTextAreaWidgetTransformer(WidgetType type) {
