 ...
 *
 */
public class TableColumnTextWidgetTransformer  extends TableColumnEditableItemWidgetTransformer {
	...
	protected Element performTransformation(WidgetTransformerContext context, Widget widget) throws CoreException {
		try {
			...
			WidgetType wt = widget.getLibrary().findWidgetType(WidgetTypeConstants.TEXTFIELD);
	 ...
	 * @param type
	 */
	public TableColumnTextWidgetTransformer(WidgetType type) {
