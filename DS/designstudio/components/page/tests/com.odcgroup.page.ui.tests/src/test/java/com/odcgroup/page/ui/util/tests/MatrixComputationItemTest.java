 ...
 *
 */
public class MatrixComputationItemTest  extends AbstractPageDesignerUnitTest {

	private static final String DOMAIN_MODEL = "domain/ds3714/SimpleData.domain";
	private static final String MODULE_MODEL = "module/Default/module/DS3737_Constraint.module";
...
//	        flushEventQueue();
			...
			String expectedErrorMsg = "The type of the first parameter is not allowed. This parameter does not contain a number.";
