 ...
 *
 */
public class MatrixDuplicateAggregatesTest extends AbstractPageDesignerUnitTest {

	private static final String DOMAIN_MODEL = "domain/ds3714/SimpleData.domain";
	private static final String MODULE_MODEL = "module/Default/module/DS3751.module";
...
//	        flushEventQueue();
			...
			String expectedErrorMsg = "The aggregation-type must be the same for the " +
					"computed column[comp_B9_16] and the attribute[mkt_val].";
