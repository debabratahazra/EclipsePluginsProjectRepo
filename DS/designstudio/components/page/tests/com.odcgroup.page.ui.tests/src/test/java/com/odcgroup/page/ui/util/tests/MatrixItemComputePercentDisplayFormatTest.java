 ...
 *
 */
public class MatrixItemComputePercentDisplayFormatTest extends AbstractPageDesignerUnitTest {

	private static final String DOMAIN_MODEL = "domain/ds3714/SimpleData.domain";
	private static final String MODULE_MODEL = "module/Default/module/DS5931.module";
	 ...
	 */
	@Test
	public void testDS5931ComputePecentDisplayFormatTest() throws PartInitException {
		...
		if (!list.isEmpty()) {
			...
			String expectedErrorMsg = "Wrong display format selected for the [compute-percentage] computation.";
