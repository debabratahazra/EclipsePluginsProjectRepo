 ...
 *
 */
public class MatrixRelativePercentComputationTest extends AbstractPageDesignerUnitTest {
	 ...
	 */
	@Test
	public void testDS3772RelativePercentComputationConstraints() throws PartInitException {
...
//	        flushEventQueue();
			...
			String expectedErrorMsg = "A Compute Percentage computation can only " +
					"use one attribute of type amount or number.";
