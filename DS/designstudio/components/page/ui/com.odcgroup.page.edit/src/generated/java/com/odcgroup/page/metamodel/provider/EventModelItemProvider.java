...
/**
 * This is the item provider adapter for a {@link com.odcgroup.page.metamodel.EventModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventModelItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetaModelPackage.Literals.EVENT_MODEL__FUNCTIONS);
			childrenFeatures.add(MetaModelPackage.Literals.EVENT_MODEL__EVENTS);
			childrenFeatures.add(MetaModelPackage.Literals.EVENT_MODEL__EVENT_TYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetaModelPackage.Literals.EVENT_MODEL__FUNCTIONS,
				 MetaModelFactory.eINSTANCE.createFunctionType()));

		newChildDescriptors.add
			(createChildParameter
				(MetaModelPackage.Literals.EVENT_MODEL__EVENTS,
				 MetaModelFactory.eINSTANCE.createWidgetEvent()));

		newChildDescriptors.add
			(createChildParameter
				(MetaModelPackage.Literals.EVENT_MODEL__EVENT_TYPES,
				 MetaModelFactory.eINSTANCE.createEventType()));
	}
