...
/**
 * This is the item provider adapter for a {@link com.odcgroup.page.metamodel.EventType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetaModelPackage.Literals.EVENT_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPropertyTypesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EventType_propertyTypes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EventType_propertyTypes_feature", "_UI_EventType_type"),
				 MetaModelPackage.Literals.EVENT_TYPE__PROPERTY_TYPES,
				 true,
				 false,
				 true,
				 null,
