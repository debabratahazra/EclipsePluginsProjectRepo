...
/**
 * This is the item provider adapter for a {@link com.odcgroup.page.metamodel.ParameterType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetaModelPackage.Literals.PARAMETER_TYPE__DEFAULT_VALUE,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterType_type_feature", "_UI_ParameterType_type"),
				 MetaModelPackage.Literals.PARAMETER_TYPE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ParameterType.class)) {
			case MetaModelPackage.PARAMETER_TYPE__DEFAULT_VALUE:
