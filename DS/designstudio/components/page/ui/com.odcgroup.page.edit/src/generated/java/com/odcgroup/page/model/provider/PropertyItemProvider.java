...
/**
 * This is the item provider adapter for a {@link com.odcgroup.page.model.Property} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.PROPERTY__VALUE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.PROPERTY__READONLY,
				 true,
				 false,
				 false,
	...
	protected void addTypeNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Property_typeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Property_typeName_feature", "_UI_Property_type"),
				 ModelPackage.Literals.PROPERTY__TYPE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLibraryNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Property_libraryName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Property_libraryName_feature", "_UI_Property_type"),
				 ModelPackage.Literals.PROPERTY__LIBRARY_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Property_model_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Property_model_feature", "_UI_Property_type"),
				 ModelPackage.Literals.PROPERTY__MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Property)object).getTypeName();
