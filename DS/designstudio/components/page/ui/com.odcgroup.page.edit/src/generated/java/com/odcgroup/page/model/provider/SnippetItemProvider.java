...
/**
 * This is the item provider adapter for a {@link com.odcgroup.page.model.Snippet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SnippetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Snippet_typeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Snippet_typeName_feature", "_UI_Snippet_type"),
				 ModelPackage.Literals.SNIPPET__TYPE_NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.SNIPPET__PROPERTIES);
			childrenFeatures.add(ModelPackage.Literals.SNIPPET__CONTENTS);
		}
	...
	public String getText(Object object) {
		String label = ((Snippet)object).getTypeName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.SNIPPET__PROPERTIES,
				 ModelFactory.eINSTANCE.createProperty()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.SNIPPET__CONTENTS,
