...
/**
 * This is the item provider adapter for a {@link com.odcgroup.page.model.Translation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TranslationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.TRANSLATION__LANGUAGE,
				 true,
				 false,
				 false,
	...
	protected void addMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Translation_message_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Translation_message_feature", "_UI_Translation_type"),
				 ModelPackage.Literals.TRANSLATION__MESSAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Translation)object).getLanguage();
