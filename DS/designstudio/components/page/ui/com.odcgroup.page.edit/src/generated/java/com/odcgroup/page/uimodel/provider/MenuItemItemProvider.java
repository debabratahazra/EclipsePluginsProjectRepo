...
/**
 * This is the item provider adapter for a {@link com.odcgroup.page.uimodel.MenuItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MenuItem_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MenuItem_parent_feature", "_UI_MenuItem_type"),
				 UIModelPackage.Literals.MENU_ITEM__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addGroupsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MenuItem_groups_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MenuItem_groups_feature", "_UI_MenuItem_type"),
				 UIModelPackage.Literals.MENU_ITEM__GROUPS,
				 true,
				 false,
				 true,
				 null,
