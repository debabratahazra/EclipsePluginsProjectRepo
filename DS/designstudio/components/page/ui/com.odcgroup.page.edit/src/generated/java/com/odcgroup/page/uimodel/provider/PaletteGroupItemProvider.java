...
/**
 * This is the item provider adapter for a {@link com.odcgroup.page.uimodel.PaletteGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UIModelPackage.Literals.PALETTE_GROUP__LABEL,
				 true,
				 false,
				 false,
	...
	protected void addItemsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PaletteGroup_items_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PaletteGroup_items_feature", "_UI_PaletteGroup_type"),
				 UIModelPackage.Literals.PALETTE_GROUP__ITEMS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addExpandedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PaletteGroup_expanded_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PaletteGroup_expanded_feature", "_UI_PaletteGroup_type"),
				 UIModelPackage.Literals.PALETTE_GROUP__EXPANDED,
				 true,
				 false,
				 false,
