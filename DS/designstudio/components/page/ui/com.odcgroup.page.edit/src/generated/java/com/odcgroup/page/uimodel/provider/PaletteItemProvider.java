...
/**
 * This is the item provider adapter for a {@link com.odcgroup.page.uimodel.Palette} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PaletteItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Palette_widgetType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Palette_widgetType_feature", "_UI_Palette_type"),
				 UIModelPackage.Literals.PALETTE__WIDGET_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPropertyTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Palette_propertyType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Palette_propertyType_feature", "_UI_Palette_type"),
				 UIModelPackage.Literals.PALETTE__PROPERTY_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPropertyValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Palette_propertyValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Palette_propertyValue_feature", "_UI_Palette_type"),
				 UIModelPackage.Literals.PALETTE__PROPERTY_VALUE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UIModelPackage.Literals.PALETTE__GROUPS);
		}
	...
	public String getText(Object object) {
		String label = ((Palette)object).getPropertyValue();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UIModelPackage.Literals.PALETTE__GROUPS,
				 UIModelFactory.eINSTANCE.createPaletteGroup()));
	}
