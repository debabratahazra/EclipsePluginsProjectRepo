 ...
 * @author atr
 */
public class MdfAssociationManyByValWidgetBuilder extends AbstractMdfAssociationWidgetBuilder {

	/**
	 * Creates a new MdfAssociationManyByValWidgetBuilder.
	 * 
	 ...
	 */
	public MdfAssociationManyByValWidgetBuilder(MdfAssociation modelElement, Widget parentWidget, WidgetBuilderContext builderContext) {
	        ...
	        if (model != null) {
	            ...
	            Dialog dialog = new MessageDialog(shell, "Error", null, //$NON-NLS-1$
	            		MessageFormat.format(msg, 
	            				new Object[]{qName.getQualifiedName(),getCardinality()}), 
    ...
    protected String getBeanPropertyPrefix() {
        return getMdfAssociation().getName();
    }
	...
	protected final String getCardinality() {
		return PropertyTypeConstants.CARDINALITY_MANY;
	}
}
