...
/**
Action to move a conditionalbody to the right for a conditional.
 * 
 * @author Gary Hayes
 */
public class MoveConditionalBodyRightAction extends AbstractMoveTabAction {

	/**
	 * Creates a new MoveConditionalBodyRightAction.
	 * 
	 * @param parameters
	 ...
	 */
	public MoveConditionalBodyRightAction(ActionParameters parameters, WidgetEditPart oldEditPart) {
