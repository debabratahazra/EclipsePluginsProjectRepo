...
/**
 * Action to move a tab to the left for a tabbed pane.
 * 
 * @author Gary Hayes
 */
public class MoveTabLeftAction extends AbstractMoveTabAction {
	 ...
	 */
	public MoveTabLeftAction(ActionParameters parameters, WidgetEditPart oldEditPart) {
