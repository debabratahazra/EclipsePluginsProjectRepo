...
/**
 * Action triggered to replace the current TableColumnEditableItem subclass by a TableColumnTextAreaItem.
 */
public class TableColumnItemMorphToTextAreaAction extends AbstractTableColumnItem {

	public TableColumnItemMorphToTextAreaAction(ActionParameters parameters, WidgetEditPart editPart) {
		super(parameters, editPart.getViewer());
		setImageDescriptor(PageUIPlugin.getImageDescriptor("/icons/obj16/textarea.png"));
	...
	protected boolean calculateEnabled() {
		...
		return !wt.equals(WidgetTypeConstants.TABLE_COLUMN_TEXT_AREA_ITEM);
	}
