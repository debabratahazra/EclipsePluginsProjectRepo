...
import com.odcgroup.page.ui.command.table.TableGroupMoveLeftCommand;
 ...
 * @author scn
 */
public class TableGroupMoveLeftAction extends AbstractTableGroupMoveAction {
	...
	protected boolean calculateEnabled() {
		...
		group = getGroup();
		return group != null ? group.canMoveLeft() : false;
	}
	 ...
	 * @param editPart 
	 */
	public TableGroupMoveLeftAction(ActionParameters parameters, WidgetEditPart editPart) {
	...
	protected Command getMoveCommand() {
		return new TableGroupMoveLeftCommand(group);
	}
