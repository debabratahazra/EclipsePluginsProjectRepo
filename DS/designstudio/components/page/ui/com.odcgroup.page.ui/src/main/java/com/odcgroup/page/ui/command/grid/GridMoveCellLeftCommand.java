 ...
 * @since DS 1.40.0
 */
public class GridMoveCellLeftCommand extends BaseCommand {
	 ...
	 */
	public void execute() {
		getGrid().moveCellLeft(getRowIndex(), getColumnIndex());
	}
	 ...
	 */
	public void undo() {
		getGrid().moveCellRight(getRowIndex(), getColumnIndex()-1);
	}
	
	/**
	 * @param cell
	 */
	public GridMoveCellLeftCommand(GridCell cell) {
