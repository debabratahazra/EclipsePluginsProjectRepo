 ...
 * @since DS 1.40.0
 */
public class GridMoveCellUpCommand extends BaseCommand {
	 ...
	 */
	public void execute() {
		getGrid().moveCellUp(getRowIndex(), getColumnIndex());
	}
	 ...
	 */
	public void undo() {
		getGrid().moveCellDown(getRowIndex()-1, getColumnIndex());
	}
	
	/**
	 * @param cell
	 */
	public GridMoveCellUpCommand(GridCell cell) {
