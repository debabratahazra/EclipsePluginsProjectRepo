 ...
 *
 */
public class TableSortMoveUpCommand extends AbstractTableSortCommand {
	 ...
	 * @param selection 
	 */
	public TableSortMoveUpCommand(ITable table, ITableSort selection) {
		super(table);
	 ...
	 */
	public void execute() {
		oneOnTop = TableHelper.getSortBeforeByRank(getTable(), selection);
