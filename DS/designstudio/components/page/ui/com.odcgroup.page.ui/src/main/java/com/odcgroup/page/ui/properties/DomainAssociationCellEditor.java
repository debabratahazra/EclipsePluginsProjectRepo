 ...
 * @author atr
 */
public class DomainAssociationCellEditor extends DialogCellEditor {
	 ...
	 */
    public DomainAssociationCellEditor(Composite parent, Property property) {
        super(parent);
    ...
    protected Object openDialogBox(Control cellEditorWindow) {
    	...
    	if (entity != null && StringUtils.isNotEmpty(entity.getValue())) {
    		...
    		DomainFilter filter = DomainFilterHelper.createAcceptFilter(
    				...
    				DomainFilterEnum.DATASET_PROPERTY_ASSOCIATION
    				);
    		...
    		if (Dialog.OK == dialog.open()) {
        		...
        		//DS-5275
        		property.getWidget().setPropertyValue(PropertyTypeConstants.BEAN_PROPERTY_PREFIX, result);
        	}
    		...
    		MessageDialog.openError(
    				cellEditorWindow.getShell(), 
    				"Error", "No Domain Entity defined");
