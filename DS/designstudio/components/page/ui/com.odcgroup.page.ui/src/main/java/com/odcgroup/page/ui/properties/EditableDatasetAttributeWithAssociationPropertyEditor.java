 ...
 */
public class EditableDatasetAttributeWithAssociationPropertyEditor extends AbstractPropertyEditor {
     ...
     */
    public EditableDatasetAttributeWithAssociationPropertyEditor(Property property) {
        super(property);
    }
	...
	public CellEditor getCellEditor(Composite parent,
		...
		CellEditor editor = new EditableDatasetAttributeCellEditor(parent, p, true);
