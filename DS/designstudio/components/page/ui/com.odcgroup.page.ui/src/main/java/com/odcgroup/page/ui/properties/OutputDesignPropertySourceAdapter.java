...
public class OutputDesignPropertySourceAdapter extends AbstractPropertySourceAdapter {
     ...
     */
    public OutputDesignPropertySourceAdapter(Property property, CommandStack commandStack) {
