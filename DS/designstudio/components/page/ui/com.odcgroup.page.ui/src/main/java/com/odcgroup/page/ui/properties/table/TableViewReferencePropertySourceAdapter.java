 ...
 * @author atr
 */
public class TableViewReferencePropertySourceAdapter extends AbstractPropertySourceAdapter {

	@Override
	public Object getPropertyValue() {
		return TableHelper.getTable(getWidget()).getViewReference();
	}
	 ...
	 */
	public TableViewReferencePropertySourceAdapter(Property property, CommandStack commandStack) {
