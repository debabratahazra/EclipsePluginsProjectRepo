...
/**
 * The class {@code TableAggregateTab} shows the aggregated columns in the
 * table.
 * 
 * @author pkk
 * @since DS.140.0
 */
public class TableAggregateTab extends TransformTableTab {
	 ...
	 * @param sortable
	 */
	public TableAggregateTab(CTabFolder parent, int style, String label, boolean sortable) {
	...
	protected ListControl<?, ITable> createTabControl(CTabFolder parent, int style) {
		return new TableAggregateSection(parent, style, isSortable());
	}
