 ...
 *
 */
public class QueryAttributesSelectionDialog extends TitleAreaDialog {
	/** */
	 ...
	 * @param desc 
	 */
	public QueryAttributesSelectionDialog(Shell parentShell, String[] attributes, String[] previousSelection, String title, String desc) {
		super(parentShell);
	 ...
	 * @return string[]
	 */
	protected String[] getSelectedAttributes() {
		return selectedAttributes.toArray(new String[0]);
	}
