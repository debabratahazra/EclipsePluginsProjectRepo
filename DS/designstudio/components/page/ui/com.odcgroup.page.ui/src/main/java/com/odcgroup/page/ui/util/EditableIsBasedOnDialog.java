...
/**
 * Dialog used to edit the "Editable is based on" property
 * @author scn
 */
public class EditableIsBasedOnDialog extends TitleAreaDialog implements ISelectionChangedListener {

	/** Window title */
	private static final String TITLE = "Editable is based on";
	...
	/** Initial condition */
	private EditableIsBasedOnCondition initialCondition;
	
	/** Result of the dialog input */
	private EditableIsBasedOnCondition resultCondition;
	 ...
	 */
	public EditableIsBasedOnDialog(Shell parentShell, DomainRepository repository, DomainFilter filter, MdfName domainEntity, EditableIsBasedOnCondition initialCondition) {
		super(parentShell);
...
//    	simplifiedTreeViewer.getTree().setFocus();
	...
	protected void okPressed() {
		resultCondition = new EditableIsBasedOnCondition(
	 ...
	 */
	public EditableIsBasedOnCondition getResultCondition() {
