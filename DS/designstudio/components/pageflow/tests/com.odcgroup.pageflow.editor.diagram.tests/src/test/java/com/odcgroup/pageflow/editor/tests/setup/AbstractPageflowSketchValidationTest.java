...
public abstract class AbstractPageflowSketchValidationTest extends
	 ...
	 * @param name
	 */
	public AbstractPageflowSketchValidationTest() {
		super();		
	}
	 ...
	 * @param pageflowName
	 */
	public AbstractPageflowSketchValidationTest(String pageflowName) {		
