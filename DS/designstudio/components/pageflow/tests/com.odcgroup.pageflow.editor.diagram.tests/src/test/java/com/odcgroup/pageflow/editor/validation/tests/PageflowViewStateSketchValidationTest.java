...
import com.odcgroup.pageflow.editor.diagram.custom.properties.section.impl.ViewStateGeneralPropertySection;
 ...
 *
 */
public class PageflowViewStateSketchValidationTest extends AbstractPageflowSketchValidationTest{
	 ...
	 * @param name
	 */
	public PageflowViewStateSketchValidationTest() {
		super(PAGEFLOW_NAME);		
	}
    ...
    public void testViewStateWithViewConstraints() throws Exception {
        ...
        is.refresh();
        String errorMsg = "| View State<<viewState>> must have at least one incoming transition | " +
        		"View State<<viewState>> must have at least one outgoing transition |";
        // check for error messages without adding view
        Assert.assertEquals("Error ", errorMsg.trim(),
                is.getErrorMsg().toString().trim());        
    }
    ...
    public void testViewStateConstraints() throws Exception {
        ...
        Assert.assertEquals("Error ", errorMsg.trim(),
                is.getErrorMsg().toString().trim());
        // check for warning messages without adding view
    ...
    public void testViewStateUniqueName() throws Exception {
        ...
        ViewStateGeneralPropertySection is = (ViewStateGeneralPropertySection) section;
        is.refresh();
        String warning = "| ViewState feature 'Name' of <<dispName>> should be unique |";
        String errorMsg = "| View State<<dispName>> must have at least one incoming transition | " +
        		"View State<<dispName>> must have at least one outgoing transition |";
