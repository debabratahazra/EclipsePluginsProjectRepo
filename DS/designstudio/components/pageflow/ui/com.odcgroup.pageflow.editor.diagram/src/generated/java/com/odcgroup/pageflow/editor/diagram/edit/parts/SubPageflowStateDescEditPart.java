 ...
 * @generated
 */
public class SubPageflowStateDescEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SubPageflowStateDescEditPart(View view) {
		super(view);
	}
	...
	/**
	 * OFSFMK-531 - Analyze - Use more distinctable widget for sub-pageflows (parent task OFSFMK-271)
	 * 
	 * @generated NOT
	 */
	protected String getLabelText() {
		...
		if (parserElement != null && parserElement instanceof SubPageflowState) {
			SubPageflowState state = (SubPageflowState) parserElement;
			if (state.getSubPageflow() != null) {
				text = state.getSubPageflow().getName();
			} else {
				text = defaultText;
			}
		}
	...
	protected void refreshFont() {
		FontStyle style = (FontStyle) getFontStyleOwnerView().getStyle(NotationPackage.eINSTANCE.getFontStyle());
		if (style != null) {
			FontData fontData = new FontData(style.getFontName(), 7, (style.isBold() ? SWT.BOLD : SWT.NORMAL)
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (PageflowPackage.eINSTANCE.getSubPageflowState_SubPageflow().equals(feature)) {
			refreshLabel();
