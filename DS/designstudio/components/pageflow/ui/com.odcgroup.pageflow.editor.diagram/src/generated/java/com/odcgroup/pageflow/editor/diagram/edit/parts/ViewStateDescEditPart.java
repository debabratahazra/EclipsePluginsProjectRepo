 ...
 * @generated
 */
public class ViewStateDescEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ViewStateDescEditPart(View view) {
		super(view);
	}
	...
	/**
	 * commented the display of description as per issue
	 * OCS-11163 (Remove description from the state display)
	 * @generated NOT
	 */
	protected String getLabelText() {
		String text = null;
		EObject parserElement = getParserElement();
		if (parserElement != null && parserElement instanceof ViewState) {
			ViewState state = (ViewState) parserElement;
			if (state.getView() != null) {
				String view = state.getView().getUrl();
				if (!view.equals("") && view.startsWith("resource:")) {
					if (view.endsWith(".page") || view.endsWith(".module")) {
						text = view.substring(view.lastIndexOf("/") + 1);
					}
				}
			} else {
				text = defaultText;
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new PageflowParserProvider.HintAdapter(PageflowElementTypes.ViewState_1004,
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (PageflowPackage.eINSTANCE.getViewState_View().equals(feature)) {
			refreshLabel();
