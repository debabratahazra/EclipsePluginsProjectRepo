 ...
 * @generated
 */
public abstract class PageflowAbstractExpression {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	protected PageflowAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = PageflowDiagramEditorPlugin.ID;
	...
	public Object evaluate(Object context, Map env) {
		if (context().isInstance(context)) {
			try {
				...
				PageflowDiagramEditorPlugin.getInstance().logError("Expression evaluation failure: " + body(), e);//$NON-NLS-1$
			}
		}
		return null;
	}
