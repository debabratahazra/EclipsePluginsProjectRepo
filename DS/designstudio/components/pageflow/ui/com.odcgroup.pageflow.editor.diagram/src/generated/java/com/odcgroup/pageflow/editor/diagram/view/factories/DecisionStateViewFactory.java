 ...
 * @generated
 */
public class DecisionStateViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint,
		...
		if (semanticHint == null) {
			semanticHint = PageflowVisualIDRegistry.getType(DecisionStateEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				PageflowVisualIDRegistry.getType(DecisionStateDisplayNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
				getPreferencesHint());
	}
}
