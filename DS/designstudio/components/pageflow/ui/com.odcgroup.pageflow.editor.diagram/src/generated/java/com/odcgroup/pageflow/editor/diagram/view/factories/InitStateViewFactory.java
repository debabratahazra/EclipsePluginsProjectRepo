 ...
 * @generated
 */
public class InitStateViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint,
		...
		if (semanticHint == null) {
			semanticHint = PageflowVisualIDRegistry.getType(InitStateEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				PageflowVisualIDRegistry.getType(InitStateDisplayNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
				getPreferencesHint());
	}
}
