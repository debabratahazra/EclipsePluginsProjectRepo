 ...
 *
 */
public class TransitionActionDefinitionDialogCreator implements IPropertyDefinitionDialogCreator {

	/* (non-Javadoc)
	 * @see com.odcgroup.workbench.editors.properties.model.IPropertyDefinitionDialogCreator#createDialog(org.eclipse.swt.widgets.Shell, org.eclipse.emf.ecore.EObject, boolean)
	 */
	@Override
	public IPropertyDefinitionDialog createDialog(Shell shell, EObject element, EObject parent, boolean update) {
		return new TransitionActionDefDialog(shell, element, parent, update);
	}
