...
public class InitStatePropertySection extends PageflowBasicPropertySection {
	...
	protected void configureProperties() {
		addAttribute(new SectionAttributePropertyHelper(Messages.InitStatePropertySectionDescLabel, PageflowPackage.eINSTANCE.getState_Desc(), null,true));
	}
