...
public class ViewStateGeneralPropertySection extends PageflowBasicPropertySection {
	...
	protected void configureProperties() {
		addAttribute(new SectionAttributePropertyHelper(Messages.ViewStateGeneralPropertySectionNameLabel, false, PageflowPackage.eINSTANCE.getState_DisplayName(), null));
		addAttribute(new SectionAttributePropertyHelper(Messages.ViewStateGeneralPropertySectionDescLabel, PageflowPackage.eINSTANCE.getState_Desc(), null,true));
	}
