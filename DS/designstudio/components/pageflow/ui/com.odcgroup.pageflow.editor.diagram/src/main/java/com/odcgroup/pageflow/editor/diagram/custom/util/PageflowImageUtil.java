...
public class PageflowImageUtil {
		...
		while(rootContents.hasNext()) {
			...
			if(rootElement instanceof Diagram){
				...
				new CopyToImageUtil().copyToImage(diagram, destinationPath, imageFormat, 
						new NullProgressMonitor(), PageflowDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT);					
			}
		}
	}
	...
	private static TransactionalEditingDomain getEditingDomain() {
		...
		editingDomain.setID("com.odcgroup.pageflow.editor.diagram.EditingDomain");
