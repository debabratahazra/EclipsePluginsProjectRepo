...
/**
 * This is the item provider adapter for a {@link com.odcgroup.pageflow.model.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_uri_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_uri_feature", "_UI_Action_type"),
				 PageflowPackage.Literals.ACTION__URI,
				 true,
				 false,
				 false,
	...
	protected void addDescPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_desc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_desc_feature", "_UI_Action_type"),
				 PageflowPackage.Literals.ACTION__DESC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PageflowPackage.Literals.ACTION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStopOnFailurePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_stopOnFailure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_stopOnFailure_feature", "_UI_Action_type"),
				 PageflowPackage.Literals.ACTION__STOP_ON_FAILURE,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PageflowPackage.Literals.ACTION__PROPERTY);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PageflowPackage.Literals.ACTION__PROPERTY,
				 PageflowFactory.eINSTANCE.createProperty()));
	}
