...
/**
 * This is the item provider adapter for a {@link com.odcgroup.pageflow.model.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider
	...
	public List getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsIdempotentPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_desc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_desc_feature", "_UI_Transition_type"),
				 PageflowPackage.Literals.TRANSITION__DESC,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PageflowPackage.Literals.TRANSITION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PageflowPackage.Literals.TRANSITION__FROM_STATE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PageflowPackage.Literals.TRANSITION__TO_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDisplayNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_displayName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_displayName_feature", "_UI_Transition_type"),
				 PageflowPackage.Literals.TRANSITION__DISPLAY_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTechDescPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_techDesc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_techDesc_feature", "_UI_Transition_type"),
				 PageflowPackage.Literals.TRANSITION__TECH_DESC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Is Idempotent feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsIdempotentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_isIdempotent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_isIdempotent_feature", "_UI_Transition_type"),
				 PageflowPackage.Literals.TRANSITION__IS_IDEMPOTENT,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PageflowPackage.Literals.TRANSITION__ACTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PageflowPackage.Literals.TRANSITION__ACTIONS,
				 PageflowFactory.eINSTANCE.createTransitionAction()));
	}
