 ...
 * @generated
 */
public class ParallelForkName2EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ProcessVisualIDRegistry
						.getType(com.odcgroup.process.diagram.edit.parts.ParallelForkName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ParallelForkName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new ProcessParserProvider.HintAdapter(
					ProcessElementTypes.ParallelFork_2005, getParserElement(),
					parserHint);
