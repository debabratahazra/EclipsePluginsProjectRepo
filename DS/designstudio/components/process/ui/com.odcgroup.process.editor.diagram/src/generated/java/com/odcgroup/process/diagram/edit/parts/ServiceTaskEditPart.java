...
import com.odcgroup.process.diagram.edit.policies.ServiceTaskItemSemanticEditPolicy;
import com.odcgroup.process.diagram.part.ProcessVisualIDRegistry;

/**
 * @generated NOT
 */
public class ServiceTaskEditPart extends ProcessItemShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ServiceTaskItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ServiceTaskNameEditPart) {
			((ServiceTaskNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTaskNameFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ServiceTaskNameEditPart.VISUAL_ID));
	}
