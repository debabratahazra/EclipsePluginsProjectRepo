 ...
 * @generated
 */
public class ExclusiveMergeItemSemanticEditPolicy extends ProcessBaseItemSemanticEditPolicy {
	...
	protected boolean allowOnlyOneOutgoingTransition(EObject source) {
		...
		if (containsExclusiveMerge(transitions, source)) {
			return false;
		}
		return true;
	}
	 ...
	 * @return
	 */
	protected boolean containsExclusiveMerge(List<?> transitions, EObject source) {
