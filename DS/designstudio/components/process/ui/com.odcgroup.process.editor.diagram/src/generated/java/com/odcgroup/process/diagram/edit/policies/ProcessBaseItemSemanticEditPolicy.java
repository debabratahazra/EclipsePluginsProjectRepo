...
import com.odcgroup.process.diagram.edit.helpers.ProcessBaseEditHelper;
import com.odcgroup.process.diagram.expressions.ProcessAbstractExpression;
import com.odcgroup.process.diagram.expressions.ProcessOCLFactory;
...
public class ProcessBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest.setParameter(ProcessBaseEditHelper.EDIT_POLICY_COMMAND, command);
			}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		private static ProcessAbstractExpression Flow_3001_SourceExpression;

		/**
		 * @generated
		 */
		private static ProcessAbstractExpression Flow_3001_TargetExpression;

		/**
		 * @generated
		 */
		public static boolean canCreateFlow_3001(Process container, ProcessItem source, ProcessItem target) {
			return canExistFlow_3001(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistFlow_3001(Process container, ProcessItem source, ProcessItem target) {
			try {
				if (source == null) {
					return true;
				}
				if (Flow_3001_SourceExpression == null) {
					Map env = Collections.singletonMap(OPPOSITE_END_VAR, ProcessPackage.eINSTANCE.getProcessItem());
					Flow_3001_SourceExpression = ProcessOCLFactory.getExpression(
							"self.oclIsTypeOf(EndEvent) <> true", ProcessPackage.eINSTANCE.getProcessItem(), env); //$NON-NLS-1$
				}
				Object sourceVal = Flow_3001_SourceExpression.evaluate(source, Collections.singletonMap(
				...
				if (Flow_3001_TargetExpression == null) {
					Map env = Collections.singletonMap(OPPOSITE_END_VAR, ProcessPackage.eINSTANCE.getProcessItem());
					Flow_3001_TargetExpression = ProcessOCLFactory.getExpression(
							"self.oclIsTypeOf(StartEvent) <> true", ProcessPackage.eINSTANCE.getProcessItem(), env); //$NON-NLS-1$
				}
				Object targetVal = Flow_3001_TargetExpression.evaluate(target, Collections.singletonMap(
