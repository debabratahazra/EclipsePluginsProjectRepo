 ...
 * @generated
 */
public class StartEventItemSemanticEditPolicy extends ProcessBaseItemSemanticEditPolicy {
	...
	protected boolean allowOnlyOneOutgoingTransition(EObject source) {
		...
		if (containsStartEvent(transitions, source)) {
			return false;
		}
		return true;
	}
	 ...
	 * @return
	 */
	protected boolean containsStartEvent(List<?> transitions, EObject source) {
