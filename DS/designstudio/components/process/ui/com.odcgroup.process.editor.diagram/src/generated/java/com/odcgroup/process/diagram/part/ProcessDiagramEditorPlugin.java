...
import com.odcgroup.process.model.provider.ProcessItemProviderAdapterFactory;
...
public class ProcessDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	public static final String ID = "com.odcgroup.process.editor.diagram"; //$NON-NLS-1$
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.ERROR, ProcessDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.INFO, ProcessDiagramEditorPlugin.ID, IStatus.OK, message, throwable));
