	...
	public void run(IAction action) {
		...
		if (diagramRoot == null) {
			MessageDialog.openError(getShell(),
					Messages.ProcessInitDiagramFileAction_InitDiagramFileResourceErrorDialogTitle,
					Messages.ProcessInitDiagramFileAction_InitDiagramFileResourceErrorDialogMessage);
			return;
		}
		Wizard wizard = new ProcessNewDiagramFileWizard(domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.ProcessInitDiagramFileAction_InitDiagramFileWizardTitle,
