 ...
 * @generated
 */
public class ProcessEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public ProcessEditPartProvider() {
		setFactory(new ProcessEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!ProcessEditPart.MODEL_ID.equals(ProcessVisualIDRegistry.getModelID(view))) {
				return false;
			}
