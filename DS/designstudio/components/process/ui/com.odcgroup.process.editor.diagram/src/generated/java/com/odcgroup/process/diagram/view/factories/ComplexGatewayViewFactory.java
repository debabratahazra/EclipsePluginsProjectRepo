 ...
 * @generated
 */
public class ComplexGatewayViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint,
		...
		if (semanticHint == null) {
			semanticHint = ProcessVisualIDRegistry.getType(ComplexGatewayEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				ProcessVisualIDRegistry.getType(ComplexGatewayNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
				getPreferencesHint());
	}
}
