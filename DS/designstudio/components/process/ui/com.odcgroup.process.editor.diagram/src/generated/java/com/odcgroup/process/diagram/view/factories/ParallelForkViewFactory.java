 ...
 * @generated
 */
public class ParallelForkViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint,
		...
		if (semanticHint == null) {
			semanticHint = ProcessVisualIDRegistry.getType(ParallelForkEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				ProcessVisualIDRegistry.getType(ParallelForkNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
				getPreferencesHint());
	}
}
