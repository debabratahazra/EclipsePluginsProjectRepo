 ...
 * @generated
 */
public class ParallelMergeViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint,
		...
		if (semanticHint == null) {
			semanticHint = ProcessVisualIDRegistry.getType(ParallelMergeEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				ProcessVisualIDRegistry.getType(ParallelMergeNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
				getPreferencesHint());
	}
}
