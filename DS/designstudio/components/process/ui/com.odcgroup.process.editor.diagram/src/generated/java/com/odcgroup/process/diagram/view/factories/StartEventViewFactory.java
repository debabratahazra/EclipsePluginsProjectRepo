 ...
 * @generated
 */
public class StartEventViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint,
		...
		if (semanticHint == null) {
			semanticHint = ProcessVisualIDRegistry.getType(StartEventEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				ProcessVisualIDRegistry.getType(StartEventNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
				getPreferencesHint());
	}
}
