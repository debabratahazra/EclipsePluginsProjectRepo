 ...
 * @generated
 */
public class UserTaskViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint,
		...
		if (semanticHint == null) {
			semanticHint = ProcessVisualIDRegistry.getType(UserTaskEditPart.VISUAL_ID);
		...
		RGB fillColor = PreferenceConverter.getColor(preferenceStore,
				ProcessPreferenceConstants.PREF_MANUALACTIVITY_SHAPE_FILL_COLOR);
		if (fillColor == null)
		...
		getViewService().createNode(eObjectAdapter, view,
				ProcessVisualIDRegistry.getType(UserTaskNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
				getPreferencesHint());
	}
}
