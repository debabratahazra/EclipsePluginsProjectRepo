...
/**
 * FIXME: remove me once we support only Ganymede.
 * STP-BPMN: copied and rename the class that will be present in Ganymede.
 * This was necessary to be compatible with eclipse-europa and the milestone of
 * eclipse-ganymede as the old WrapLabel was not backward compatible for the stp-bpmn
 * modeler. The old WrapLabel is also used for the VerticalLabel of pools and lanes.
 * 
