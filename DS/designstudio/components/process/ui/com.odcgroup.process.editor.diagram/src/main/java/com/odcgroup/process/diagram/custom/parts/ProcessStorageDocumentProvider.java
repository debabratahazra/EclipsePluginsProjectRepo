 ...
 *
 */
public class ProcessStorageDocumentProvider extends StorageDocumentProvider implements IDiagramDocumentProvider {
	...
	private void handleError(Throwable exception) throws CoreException {
		...
		IStatus status = new Status(IStatus.ERROR, ProcessDiagramEditorPlugin.ID, 1, reason, exception);
