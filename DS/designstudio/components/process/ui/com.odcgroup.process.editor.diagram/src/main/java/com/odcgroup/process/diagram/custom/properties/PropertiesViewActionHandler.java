...
public class PropertiesViewActionHandler {
	...
	public PropertiesViewActionHandler(IActionBars actionBar) {
		...
		actionBar.getToolBarManager().add(OfsHelpHelper.createHelpAction(IOfsHelpContextIds.WORKFLOW_PROPERTIES));
	}
