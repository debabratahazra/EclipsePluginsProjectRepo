...
public class ConnectionPropertySection extends ProcessBasicPropertySection {
	...
	protected void configureProperties() {
		addAttribute(new SectionAttributePropertyHelper("Name", ProcessPackage.eINSTANCE.getFlow_Name(), null));	
	}
