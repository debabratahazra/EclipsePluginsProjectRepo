...
public class NamedElementPropertySection extends ProcessBasicPropertySection {
	...
	protected void configureProperties() {	
		addAttribute(new SectionAttributePropertyHelper("Name", ProcessPackage.eINSTANCE.getNamedElement_Name(), null));		
