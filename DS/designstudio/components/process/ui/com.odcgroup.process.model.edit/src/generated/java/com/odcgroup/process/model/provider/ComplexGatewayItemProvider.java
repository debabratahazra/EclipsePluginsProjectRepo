...
/**
 * This is the item provider adapter for a {@link com.odcgroup.process.model.ComplexGateway} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComplexGatewayItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComplexGateway_rule_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComplexGateway_rule_feature", "_UI_ComplexGateway_type"),
				 ProcessPackage.Literals.COMPLEX_GATEWAY__RULE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProcessPackage.Literals.COMPLEX_GATEWAY__SERVICE);
			childrenFeatures.add(ProcessPackage.Literals.COMPLEX_GATEWAY__SCRIPT);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProcessPackage.Literals.COMPLEX_GATEWAY__SERVICE,
				 ProcessFactory.eINSTANCE.createService()));

		newChildDescriptors.add
			(createChildParameter
				(ProcessPackage.Literals.COMPLEX_GATEWAY__SCRIPT,
				 ProcessFactory.eINSTANCE.createScript()));
	}
