...
/**
 * This is the item provider adapter for a {@link com.odcgroup.process.model.Script} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScriptItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Script_language_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Script_language_feature", "_UI_Script_type"),
				 ProcessPackage.Literals.SCRIPT__LANGUAGE,
				 true,
				 false,
				 false,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Script_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Script_value_feature", "_UI_Script_type"),
				 ProcessPackage.Literals.SCRIPT__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		ScriptingLanguage labelValue = ((Script)object).getLanguage();
