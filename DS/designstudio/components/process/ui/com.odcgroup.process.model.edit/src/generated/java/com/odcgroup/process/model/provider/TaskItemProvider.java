...
/**
 * This is the item provider adapter for a {@link com.odcgroup.process.model.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider
	extends ProcessItemItemProvider
	implements	
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_initial_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_initial_feature", "_UI_Task_type"),
				 ProcessPackage.Literals.TASK__INITIAL,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProcessPackage.Literals.TASK__TRANSLATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProcessPackage.Literals.TASK__TRANSLATIONS,
