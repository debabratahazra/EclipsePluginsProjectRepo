...
/**
 * This is the item provider adapter for a {@link com.odcgroup.process.model.UserTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UserTask_pageflow_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UserTask_pageflow_feature", "_UI_UserTask_type"),
				 ProcessPackage.Literals.USER_TASK__PAGEFLOW,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRulePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UserTask_rule_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UserTask_rule_feature", "_UI_UserTask_type"),
				 ProcessPackage.Literals.USER_TASK__RULE,
				 true,
				 false,
				 true,
				 null,
