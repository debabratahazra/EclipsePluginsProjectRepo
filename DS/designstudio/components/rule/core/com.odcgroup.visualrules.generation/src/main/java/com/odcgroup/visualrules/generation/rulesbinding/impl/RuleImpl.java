 ...
 * <ul>
 *   <li>{@link com.odcgroup.visualrules.generation.rulesbinding.impl.RuleImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RuleImpl extends MinimalEObjectImpl.Container implements Rule {
	...
	protected EClass eStaticClass() {
		return RulesBindingPackage.Literals.RULE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulesBindingPackage.RULE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RulesBindingPackage.RULE__NAME:
				return getName();
		}
