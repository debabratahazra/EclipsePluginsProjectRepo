package com.odcgroup.service.gen.t24.internal.categories.cpp.data;

import java.util.ArrayList;
import java.util.List;

import com.odcgroup.service.gen.t24.AbstractComponentCodeGenerator2;
import com.odcgroup.service.gen.t24.internal.cartridges.cpp.CppServiceDataGenerator;
...
public class CppServiceDataCodeGenerator extends AbstractComponentCodeGenerator2 {

	@Override
	protected List<ServiceGenerator> getServiceGenerator() {
		List<ServiceGenerator> generators = new ArrayList<ServiceGenerator>();
		generators.add(new CppServiceDataGenerator(new TemplateOutsideJarLoader()));
		return generators;
	}
