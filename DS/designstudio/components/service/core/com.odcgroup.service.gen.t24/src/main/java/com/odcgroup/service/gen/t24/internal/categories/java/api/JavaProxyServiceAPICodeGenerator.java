...
import com.odcgroup.service.gen.t24.internal.generator.JavaProxyServiceAPIGenerator;
...
public class JavaProxyServiceAPICodeGenerator extends AbstractComponentCodeGenerator2 {
	...
	protected List<ServiceGenerator> getServiceGenerator() throws LoadTemplateException {
		...
		generators.add(new JavaProxyServiceAPIGenerator(new TemplateOutsideJarLoader()));
		return generators;
	}
}
