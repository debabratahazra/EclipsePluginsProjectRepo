...
import com.odcgroup.service.gen.t24.internal.generator.JavaServiceGenerator;
...
public class JavaServiceCodeGenerator extends AbstractComponentCodeGenerator2 {
	Logger logger = LoggerFactory.getLogger(JavaServiceCodeGenerator.class);
	...
	protected List<ServiceGenerator> getServiceGenerator() throws LoadTemplateException {
		...
		generators.add(new JavaServiceGenerator(new TemplateOutsideJarLoader()));
		return generators;
	}
}
