...
import com.odcgroup.service.gen.t24.internal.generator.JavaDataClassGenerator;
...
public class JavaDataClassCodeGenerator extends AbstractComponentCodeGenerator2 {
	Logger logger = LoggerFactory.getLogger(JavaDataClassCodeGenerator.class);
	...
	protected List<ServiceGenerator> getServiceGenerator() throws LoadTemplateException {
		...
		generators.add(new JavaDataClassGenerator(new TemplateOutsideJarLoader()));
		return generators;
	}
}
