...
import com.odcgroup.service.gen.t24.internal.generator.JavaDataClassConverterGenerator;
...
public class JavaDataClassConverterCodeGenerator extends AbstractComponentCodeGenerator2 {
	Logger logger = LoggerFactory.getLogger(JavaDataClassConverterCodeGenerator.class);
	...
	protected List<ServiceGenerator> getServiceGenerator() throws LoadTemplateException {
		...
		generators.add(new JavaDataClassConverterGenerator(new TemplateOutsideJarLoader()));
		return generators;
	}
}
