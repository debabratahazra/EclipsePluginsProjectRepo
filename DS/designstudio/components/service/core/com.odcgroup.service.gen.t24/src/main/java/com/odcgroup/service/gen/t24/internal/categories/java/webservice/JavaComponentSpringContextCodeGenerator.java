...
public class JavaComponentSpringContextCodeGenerator extends AbstractComponentCodeGenerator2 {
	Logger logger = LoggerFactory.getLogger(JavaComponentSpringContextCodeGenerator.class);
	...
	protected List<ServiceGenerator> getServiceGenerator() throws LoadTemplateException {
		...
		generators.add(new JavaComponentSpringContextGenerator(new TemplateOutsideJarLoader()));
		return generators;
	}
