...
import com.odcgroup.service.gen.t24.internal.generator.JavaProviderServiceGenerator;
...
public class JavaProviderServiceCodeGenerator extends AbstractComponentCodeGenerator2 {
	Logger logger = LoggerFactory.getLogger(JavaProviderServiceCodeGenerator.class);
	...
	protected List<ServiceGenerator> getServiceGenerator() throws LoadTemplateException {
		...
		generators.add(new JavaProviderServiceGenerator(new TemplateOutsideJarLoader()));
		return generators;
	}
}
