...
public class JavaWSApplicationContextXMLCodeGenerator extends AbstractComponentCodeGenerator2 {
	Logger logger = LoggerFactory.getLogger(JavaWSApplicationContextXMLCodeGenerator.class);
	...
	protected List<ServiceGenerator> getServiceGenerator() throws LoadTemplateException {
		...
		generators.add(new JavaWSApplicationContextXMLGenerator(new TemplateOutsideJarLoader()));
		return generators;
	}
}
