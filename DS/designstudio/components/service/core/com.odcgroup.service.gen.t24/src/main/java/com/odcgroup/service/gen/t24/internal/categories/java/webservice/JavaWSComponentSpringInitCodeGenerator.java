...
public class JavaWSComponentSpringInitCodeGenerator extends AbstractComponentCodeGenerator2 {
	Logger logger = LoggerFactory.getLogger(JavaWSComponentSpringInitCodeGenerator.class);
	...
	protected List<ServiceGenerator> getServiceGenerator() throws LoadTemplateException {
		...
		generators.add(new JavaWSComponentSpringInitGenerator(new TemplateOutsideJarLoader()));
		return generators;
	}
