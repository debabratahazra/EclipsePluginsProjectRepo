...
public class JavaWSSpringContextCodeGenerator extends AbstractComponentCodeGenerator2 {
	Logger logger = LoggerFactory.getLogger(JavaWSSpringContextCodeGenerator.class);
