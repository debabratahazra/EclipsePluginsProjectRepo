...
import com.odcgroup.service.gen.t24.internal.generator.BasicImplementationGenerator;
...
public class BasicImplementationCodeGenerator extends AbstractComponentCodeGenerator2 {
	Logger logger = LoggerFactory.getLogger(BasicImplementationCodeGenerator.class);
	...
	protected List<ServiceGenerator> getServiceGenerator() throws LoadTemplateException {
		...
		generators.add(new BasicImplementationGenerator(new TemplateOutsideJarLoader()));
		return generators;
	}
}
