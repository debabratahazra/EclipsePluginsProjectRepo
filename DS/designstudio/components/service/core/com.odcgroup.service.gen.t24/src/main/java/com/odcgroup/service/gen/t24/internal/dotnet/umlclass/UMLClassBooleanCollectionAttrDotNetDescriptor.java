...
public class UMLClassBooleanCollectionAttrDotNetDescriptor 
	...
	//.NET TYPE
	private static final String DOT_NET_TYPE = "List<bool>^";
	// .NET c# TYPE
	private static final String DOT_NET_CS_TYPE = "List<bool>";
	//.NET base type
	private static final String DOT_NET_BASE_TYPE = "bool";
	//default .net value 
	private static final String DOT_NET_DEFAULT_VALUE="gcnew List<bool>()";
	//default .net c# value 
	private static final String DOT_NET_CS_DEFAULT_VALUE="List<bool>()";
	
	public UMLClassBooleanCollectionAttrDotNetDescriptor(String umlName,
			                                   int index,
