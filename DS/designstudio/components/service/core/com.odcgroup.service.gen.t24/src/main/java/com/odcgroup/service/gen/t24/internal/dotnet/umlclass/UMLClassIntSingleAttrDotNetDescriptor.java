...
public class UMLClassIntSingleAttrDotNetDescriptor extends
	...
	private static final String DOT_NET_TYPE = "int";  
	//default value to initialize this member
	//in managed business object default constructor
	private static final String DOT_NET_DEFAULT_VALUE = "0";
  
	public UMLClassIntSingleAttrDotNetDescriptor(String umlName,
																		int index,
