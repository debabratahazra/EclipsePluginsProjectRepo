...
public class UMLBooleanSingleParaDotNetDescriptor 
	...
	//.NET type
	private static final String DOTNET_TYPE = "bool";
	
	public UMLBooleanSingleParaDotNetDescriptor(String umlName,
												Direction direction,
												boolean isMandatory,
	...
	public String getDotNetWCFType() {
		return DOTNET_TYPE;	// They are the same so keep it as is
	}
