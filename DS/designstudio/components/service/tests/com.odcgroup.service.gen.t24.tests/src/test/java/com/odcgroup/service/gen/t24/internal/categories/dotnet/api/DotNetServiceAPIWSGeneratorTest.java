...
/**
 * To test DotNetWSGenerator
 *
 * @author sjunejo
 *
 */
public class DotNetServiceAPIWSGeneratorTest extends TestCase {
	private UMLServiceDotNetDescriptor umlService;
	private DotNetServiceAPIWSGenerator generator;

	//construct uml service model
		protected void setUp() {
			generator = new DotNetServiceAPIWSGenerator(new TemplateOutsideJarLoader());
