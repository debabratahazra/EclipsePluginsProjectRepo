...
public class JavaWebServiceSecEnabledGeneratorTest {
	@Test
	public void testRefactoredGenerate() throws LoadTemplateException {
		...
		JavaWebServiceSecEnabledGenerator generator = new JavaWebServiceSecEnabledGenerator(new TemplateOutsideJarLoader());
		...
		assertTrue(output.contains("WebService(name = \"MySpecialServiceSecWS\", serviceName=\"MySpecialServiceSecWS\")"));
		
		assertTrue(output.contains("public OperationOneResponse operationOne(String id, Integer[] numbers, OnlyOne onlyOne, CouldBeLots[] couldBeLots) {"));
		...
		assertTrue(output.contains("public OperationTwoResponse operationTwo() {"));
