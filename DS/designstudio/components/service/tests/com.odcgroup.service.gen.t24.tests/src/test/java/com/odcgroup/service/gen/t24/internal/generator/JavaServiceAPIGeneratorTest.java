...
public class JavaServiceAPIGeneratorTest {
	@Test
	public void testRefactoredGenerate() throws LoadTemplateException {
		...
		JavaServiceAPIGenerator generator = new JavaServiceAPIGenerator(new TemplateOutsideJarLoader());
		generator.generate(service, outputWriter, "");
		
		String output = outputWriter.toString();
		//System.out.println(output);
		assertTrue(output.contains("public interface MySpecialServiceAPI extends MySpecialService {"));
	}

	@Test
	public void testRefactoredGenerateExternal() throws LoadTemplateException {
		Writer outputWriter = new StringWriter();
		...
		ServiceDescriptor service = new ServiceDescriptor("MySpecialService", operations, classDefDescriptors,"1.30.8");
