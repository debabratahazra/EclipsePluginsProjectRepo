package com.odcgroup.service.model.ui.command.handler;
...
public class SaveAndGenerateServiceHandler extends AbstractHandler {
	...
	private void generateCode(IEditorPart editor, IFile file) throws ExecutionException {			
		...
		try {
			Command command = commandService.getCommand("com.odcgroup.workbench.gen.ui.GenerateCodeHandler");
