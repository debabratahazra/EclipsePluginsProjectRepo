...
/**
 * This is the item provider adapter for a {@link com.odcgroup.t24.enquiry.enquiry.Axis} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AxisItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDisplayLegendPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Axis_field_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Axis_field_feature", "_UI_Axis_type"),
				 EnquiryPackage.Literals.AXIS__FIELD,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Axis_displayLegend_feature", "_UI_Axis_type"),
				 EnquiryPackage.Literals.AXIS__DISPLAY_LEGEND,
				 true,
				 false,
				 false,
	...
	protected void addShowGridPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Axis_showGrid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Axis_showGrid_feature", "_UI_Axis_type"),
				 EnquiryPackage.Literals.AXIS__SHOW_GRID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
