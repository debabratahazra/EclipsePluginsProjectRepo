...
/**
 * This is the item provider adapter for a {@link com.odcgroup.t24.enquiry.enquiry.Dimension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EnquiryPackage.Literals.DIMENSION__WIDTH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EnquiryPackage.Literals.DIMENSION__HEIGHT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addOrientationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dimension_orientation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dimension_orientation_feature", "_UI_Dimension_type"),
				 EnquiryPackage.Literals.DIMENSION__ORIENTATION,
				 true,
				 false,
				 false,
