...
/**
 * This is the item provider adapter for a {@link com.odcgroup.t24.enquiry.enquiry.Reference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_file_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_file_feature", "_UI_Reference_type"),
				 EnquiryPackage.Literals.REFERENCE__FILE,
				 true,
				 false,
				 false,
	...
	protected void addFieldPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_field_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_field_feature", "_UI_Reference_type"),
				 EnquiryPackage.Literals.REFERENCE__FIELD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Reference)object).getFile();
