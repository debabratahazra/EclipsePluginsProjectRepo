...
/**
 * This is the item provider adapter for a {@link com.odcgroup.t24.enquiry.enquiry.Security} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SecurityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Security_application_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Security_application_feature", "_UI_Security_type"),
				 EnquiryPackage.Literals.SECURITY__APPLICATION,
				 true,
				 false,
				 false,
	...
	protected void addFieldPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Security_field_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Security_field_feature", "_UI_Security_type"),
				 EnquiryPackage.Literals.SECURITY__FIELD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAbortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Security_abort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Security_abort_feature", "_UI_Security_type"),
				 EnquiryPackage.Literals.SECURITY__ABORT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Security)object).getApplication();
