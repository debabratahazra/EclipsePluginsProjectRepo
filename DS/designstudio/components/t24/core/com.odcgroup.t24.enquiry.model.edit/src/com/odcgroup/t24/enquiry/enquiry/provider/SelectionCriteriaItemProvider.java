...
/**
 * This is the item provider adapter for a {@link com.odcgroup.t24.enquiry.enquiry.SelectionCriteria} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SelectionCriteriaItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SelectionCriteria_field_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SelectionCriteria_field_feature", "_UI_SelectionCriteria_type"),
				 EnquiryPackage.Literals.SELECTION_CRITERIA__FIELD,
				 true,
				 false,
				 false,
	...
	protected void addOperandPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SelectionCriteria_operand_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SelectionCriteria_operand_feature", "_UI_SelectionCriteria_type"),
				 EnquiryPackage.Literals.SELECTION_CRITERIA__OPERAND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addValuesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SelectionCriteria_values_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SelectionCriteria_values_feature", "_UI_SelectionCriteria_type"),
				 EnquiryPackage.Literals.SELECTION_CRITERIA__VALUES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((SelectionCriteria)object).getField();
		return label == null || label.length() == 0 ?
			getString("_UI_SelectionCriteria_type") :
