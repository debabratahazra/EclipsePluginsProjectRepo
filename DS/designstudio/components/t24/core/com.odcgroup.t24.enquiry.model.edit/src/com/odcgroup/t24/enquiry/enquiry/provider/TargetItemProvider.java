...
/**
 * This is the item provider adapter for a {@link com.odcgroup.t24.enquiry.enquiry.Target} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TargetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Target_application_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Target_application_feature", "_UI_Target_type"),
				 EnquiryPackage.Literals.TARGET__APPLICATION,
				 true,
				 false,
				 false,
	...
	protected void addScreenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Target_screen_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Target_screen_feature", "_UI_Target_type"),
				 EnquiryPackage.Literals.TARGET__SCREEN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EnquiryPackage.Literals.TARGET__MAPPINGS);
		}
	...
	public String getText(Object object) {
		String label = ((Target)object).getApplication();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EnquiryPackage.Literals.TARGET__MAPPINGS,
				 EnquiryFactory.eINSTANCE.createTargetMapping()));
	}
