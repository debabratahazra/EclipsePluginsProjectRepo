...
/**
 * This is the item provider adapter for a {@link com.odcgroup.t24.enquiry.enquiry.Tool} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ToolItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EnquiryPackage.Literals.TOOL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCommandPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tool_command_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tool_command_feature", "_UI_Tool_type"),
				 EnquiryPackage.Literals.TOOL__COMMAND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EnquiryPackage.Literals.TOOL__LABEL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EnquiryPackage.Literals.TOOL__LABEL,
