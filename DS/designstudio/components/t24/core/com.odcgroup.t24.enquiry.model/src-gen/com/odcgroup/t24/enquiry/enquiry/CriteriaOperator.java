...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Criteria Operator</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.odcgroup.t24.enquiry.enquiry.EnquiryPackage#getCriteriaOperator()
 * @model
 * @generated
 */
public enum CriteriaOperator implements Enumerator
{
  /**
  ...
  /**
   * The '<em><b>Greater Than Symbol</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #GREATER_THAN_SYMBOL_VALUE
   * @generated
   * @ordered
   */
  GREATER_THAN_SYMBOL(18, "GreaterThanSymbol", ">");
  ...
  /**
   * The '<em><b>Greater Than Symbol</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Greater Than Symbol</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #GREATER_THAN_SYMBOL
   * @model name="GreaterThanSymbol" literal=">"
   * @generated
   * @ordered
   */
  public static final int GREATER_THAN_SYMBOL_VALUE = 18;

  /**
   * An array of all the '<em><b>Criteria Operator</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final CriteriaOperator[] VALUES_ARRAY =
  ...
  /**
   * A public read-only list of all the '<em><b>Criteria Operator</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<CriteriaOperator> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Criteria Operator</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static CriteriaOperator get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      CriteriaOperator result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Criteria Operator</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Criteria Operator</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static CriteriaOperator get(int value)
  {
    switch (value)
    {
      ...
      case GREATER_THAN_SYMBOL_VALUE: return GREATER_THAN_SYMBOL;
    }
    return null;
  }
   ...
   * @generated
   */
  private CriteriaOperator(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
