package com.odcgroup.t24.maven.template.provider;
...
import com.odcgroup.t24.maven.T24MavenCore;
...
public class PomTemplateProvider implements IPomTemplatesProvider {
	...
	private String getPomTemplate(String templateName) throws CoreException {
		...
		try {
			URL pomUrl = T24MavenCore.getDefault().getBundle().getResource("templates/" + templateName);
