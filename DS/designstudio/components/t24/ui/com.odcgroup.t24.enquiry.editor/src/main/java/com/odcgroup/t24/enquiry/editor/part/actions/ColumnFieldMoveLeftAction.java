 ...
 * 
 */
public class ColumnFieldMoveLeftAction extends AbstractMoveAction {

	public static final String ACTION_ID = "MOVE_LEFT";
	private Request request;

	/**
	 * @param part
	 */
	public ColumnFieldMoveLeftAction(IWorkbenchPart part) {
		super(part);
		setId(ACTION_ID);
		setText("Move Left");
