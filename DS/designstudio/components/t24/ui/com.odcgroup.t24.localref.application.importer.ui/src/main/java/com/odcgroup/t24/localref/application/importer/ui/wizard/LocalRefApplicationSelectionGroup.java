...
public class LocalRefApplicationSelectionGroup {
	...
	private static class ContentProvider implements IStructuredContentProvider {
		...
		public Object[] getElements(Object inputElement) {
			return ((List<LocalRefApplicationDetail>)inputElement).toArray();
		}
	...
	private static class TableLabelProvider extends LabelProvider implements
		...
		public String getColumnText(Object element, int columnIndex) {
			LocalRefApplicationDetail localRefApplication = (LocalRefApplicationDetail) element;
			String result = ""; //$NON-NLS-1$
			switch (columnIndex) {
			case 0: {
				String str = localRefApplication.getName();
				result = StringUtils.isBlank(str) ? Messages.LocalRefApplicationSelectionGroup_localRefDefaultName : str;
				break;
			}
			default:
	...
	public class LocalRefApplicationSorter extends ViewerSorter {
		...
		public int compare(Viewer viewer, Object e1, Object e2) {
			LocalRefApplicationDetail v1 = (LocalRefApplicationDetail) e1;
			LocalRefApplicationDetail v2 = (LocalRefApplicationDetail) e2;
			int rc = 0;
			switch (column) {
			case 0:
		...
		public LocalRefApplicationSorter() {
			this.column = 0;
			direction = ASCENDING;
		}
	...
	private void createColumn(TableColumnLayout layout, final int columnIndex, String header, int weight) {
		...
		tc.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent event) {
				((LocalRefApplicationSorter) tableViewer.getSorter()).setColumn(columnIndex);
				tableViewer.refresh();
			}
		});
	...
	public void createContents(Composite parent) {
		...
		previewGroup.setText(Messages.LocalRefApplicationSelectionGroup_previewGroupLabel);
		...
		tableViewer.setSorter(new LocalRefApplicationSorter());

		TableColumnLayout layout = new TableColumnLayout();
		composite.setLayout(layout);
		createColumn(layout, 0, Messages.LocalRefApplicationSelectionGroup_columnLocalRef, 100);
		...
		tableViewer.addCheckStateListener(new ICheckStateListener() {
			...
			public void checkStateChanged(CheckStateChangedEvent event) {
				...
				if (event.getChecked()) {
					...
					selector.getSelectedModels().add((LocalRefApplicationDetail) element);
		...
		selectButton.setText(Messages.LocalRefApplicationSelectionGroup_SelectAll);
		...
		deselectButton.setText(Messages.LocalRefApplicationSelectionGroup_UnselectAll);
	...
	public void setInput(List<LocalRefApplicationDetail> localRefList) {
		if (tableViewer != null) {
	 ...
	 *            required.
	 */
	public LocalRefApplicationSelectionGroup(Composite parent, Listener listener,
			ILocalRefApplicationSelector selector, String message) {
