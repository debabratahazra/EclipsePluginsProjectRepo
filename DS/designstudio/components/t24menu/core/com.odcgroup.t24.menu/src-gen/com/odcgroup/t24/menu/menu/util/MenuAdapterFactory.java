/**
 */
package com.odcgroup.t24.menu.menu.util;

import com.odcgroup.t24.menu.menu.*;
 ...
 * <!-- end-user-doc -->
 * @see com.odcgroup.t24.menu.menu.MenuPackage
 * @generated
 */
public class MenuAdapterFactory extends AdapterFactoryImpl
{
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.odcgroup.t24.menu.menu.MenuRoot <em>Root</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.odcgroup.t24.menu.menu.MenuItem <em>Item</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.odcgroup.t24.menu.menu.Translation <em>Translation</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
