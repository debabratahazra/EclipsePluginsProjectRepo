...
public class MenuParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected com.odcgroup.t24.menu.parser.antlr.internal.InternalMenuParser createParser(XtextTokenStream stream) {
		return new com.odcgroup.t24.menu.parser.antlr.internal.InternalMenuParser(stream, getGrammarAccess());
	}
