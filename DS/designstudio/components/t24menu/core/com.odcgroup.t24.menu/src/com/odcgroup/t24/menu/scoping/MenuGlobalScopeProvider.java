 ...
 * 
 */
public class MenuGlobalScopeProvider /*extends ResourceSetGlobalScopeProvider*/ extends DefaultGlobalScopeProvider {
	
	@Override
	protected List<IContainer> getVisibleContainers(Resource resource) {
		// work around as the index knows platform uri for the resourcedescription
