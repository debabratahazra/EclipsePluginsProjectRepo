...
public class XMLWriter extends XMLFilterImpl implements LexicalHandler {
	...
	public void startElement(String uri, String localName, String qName, Attributes atts) throws SAXException {
		boolean firstElement = elementLevel < 1;
		indent();
		elementLevel++;
		...
		// System.out.println("%%%% startElement [" + qName + "] htmlMode = " +
		// htmlMode);
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		if (!(htmlMode && (uri.equals("http://www.w3.org/1999/xhtml") || uri.equals("")) && (qName.equals("area")
				|| qName.equals("base") || qName.equals("basefont") || qName.equals("br") || qName.equals("col")
				|| qName.equals("frame") || qName.equals("hr") || qName.equals("img") || qName.equals("input")
				|| qName.equals("isindex") || qName.equals("link") || qName.equals("meta") || qName.equals("param")))) {
			write("</");
			writeName(uri, localName, qName, true);
			write('>');
		}
	...
	private String[] booleans = { "checked", "compact", "declare", "defer", "disabled", "ismap", "multiple", "nohref",
	...
	private void indent() throws SAXException {
		if (indent) {
			for (int i = 0; i < elementLevel*indentStep; i++) {
				write(' ');
			}
		}
    }
	...
	public void setOutputProperty(String key, String value) {
		...
		if (key.equals(ENCODING)) {
			...
			indentStep = Integer.parseInt(value);
			indent = indentStep > 0;
		}
