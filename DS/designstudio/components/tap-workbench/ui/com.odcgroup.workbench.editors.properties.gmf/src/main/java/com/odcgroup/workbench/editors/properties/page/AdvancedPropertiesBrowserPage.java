package com.odcgroup.workbench.editors.properties.page;
...
public abstract class AdvancedPropertiesBrowserPage extends AdvancedTabbedPropertySheetPage implements IPropertyChangeListener, IEditingDomainProvider {
	...
	private IPartListener modelerViewActivationListener = new IPartListener() {
		...
		public void partActivated(IWorkbenchPart part) {
			...
			propertiesBrowserActive = (part instanceof PropertySheet && ((PropertySheet) part)
				.getCurrentPage().equals(AdvancedPropertiesBrowserPage.this));
		}
						...
						new ISelectionChangedListener() {
							...
							public void selectionChanged(
								...
								if (!newModelerViewSelection
									 ...
									 */
									AdvancedPropertiesBrowserPage.this
	 ...
	 */
	public AdvancedPropertiesBrowserPage(ITabbedPropertySheetPageContributor contributor) {
		super(contributor);
