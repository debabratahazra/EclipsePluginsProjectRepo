 ...
 * @author Yasser Lulu 
 */
public class ConnectorViewPasteOp
		...
		return new PostPasteChildOperation(this, EMPTY_ARRAY) {
			...
			public PasteChildOperation getPostPasteOperation() {
				return new PostPasteChildOperation(this, EMPTY_ARRAY) {
					...
					public PasteChildOperation getPostPasteOperation() {
						return new ConnectorViewPostPasteChildOp(
							ConnectorViewPasteOp.this,
							ConnectorViewPasteOp.this.pasteSemanticElement);
					}
				};
			}
		};
