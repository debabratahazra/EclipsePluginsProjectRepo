...
import ch.vorburger.el.serializer.ELSemanticSequencer;
...
public abstract class AbstractDSELSemanticSequencer extends ELSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ELPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case XbasePackage.XBASIC_FOR_LOOP_EXPRESSION:
				if(context == grammarAccess.getXBasicForLoopExpressionRule()) {
			...
			case XbasePackage.XSYNCHRONIZED_EXPRESSION:
				if(context == grammarAccess.getXSynchronizedExpressionRule()) {
