 ...
 * 
 */
public abstract class AbstractXtextTest {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(AbstractXtextTest.class);
    ...
    public AbstractXtextTest() {
        this ("/");
    }

    public AbstractXtextTest(String resourceRoot) {
...
// This doesn't work on a build server, only in the eclipse workspace
//    @BeforeClass
...
//    }
    ...
    protected FluentIssueCollection testFile(String fileToTest, String... referencedResources) {
        ...
        for (String referencedResource : referencedResources) {
            URI uri = getURI(referencedResource);
