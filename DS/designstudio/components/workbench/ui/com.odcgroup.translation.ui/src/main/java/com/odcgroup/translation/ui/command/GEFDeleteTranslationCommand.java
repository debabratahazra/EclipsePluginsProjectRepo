 ...
 * @author atr
 */
public class GEFDeleteTranslationCommand extends GEFTranslationCommand {
	 ...
	 * @param text
	 */
	public GEFDeleteTranslationCommand(ITranslation translation, ITranslationKind kind, Locale locale) {
