...
class IncreaseWrappedLinesIndent extends LineIndentHandler {
	...
	public final void updateStyle(boolean selected) {
		...
		for (int line = firstLine; line <= lastLine; line++) {
			...
			if (bullet == null) {
				int indent = getText().getLineWrapIndent(line) + getIncrement();
	...
	public IncreaseWrappedLinesIndent(StyledText text) {
		super(text);
	}
}
