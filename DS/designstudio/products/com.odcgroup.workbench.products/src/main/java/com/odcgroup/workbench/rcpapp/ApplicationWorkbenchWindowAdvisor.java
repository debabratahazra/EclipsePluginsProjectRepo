...
public class ApplicationWorkbenchWindowAdvisor extends WorkbenchWindowAdvisor {
    ...
    public void preWindowOpen() {
        ...
        PlatformUI.getPreferenceStore().setDefault("REUSE_OPEN_EDITORS", 20);
        PlatformUI.getPreferenceStore().setDefault("REUSE_OPEN_EDITORS_BOOLEAN", true);
        ...
        // deactivate VisualRules technical help
        try {
        	Bundle vrJavaDocBundle = Platform.getBundle("de.visualrules.java.doc");
			vrJavaDocBundle.stop();
			vrJavaDocBundle.uninstall();
	        Bundle vrRuntimeDocBundle = Platform.getBundle("de.visualrules.runtime.doc");
	        vrRuntimeDocBundle.stop();
	        vrRuntimeDocBundle.uninstall();
	        Bundle vr3importDocBundle = Platform.getBundle("de.visualrules.vr3import.doc");
	        vr3importDocBundle.stop();
	        vr3importDocBundle.uninstall();
		} catch (BundleException e) {
			OfsCore.getDefault().logWarning("Could not deactivate VisualRules technical documentation bundles", e);
		}
    ...
    private void hideActionsforPage(IWorkbenchPage page) {
    	...
    	page.hideActionSet("de.visualrules.ui.controls.openElementsActionSet");
