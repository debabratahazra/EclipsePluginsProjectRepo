...
<xsl:template match="*[contains(@class,' task/stepxmp ')]" name="topic.task.stepxmp">
  ...
  <div class="stepexample">
  	<span class="stepexample-title">Example</span>
...
<xsl:template match="*[contains(@class,' task/stepresult ')]" name="topic.task.stepresult">
  ...
  <div class="stepresult">
  	  <span class="stepresult-title">Result</span>
	  <xsl:call-template name="revblock">
	    <xsl:with-param name="flagrules" select="$flagrules"></xsl:with-param>
	  </xsl:call-template>
  </div>
...
<xsl:template match="*[contains(@class,' task/context ')]" name="task.context">
  <xsl:variable name="flagrules">
    <xsl:call-template name="getrules"/>
  </xsl:variable>
  <xsl:variable name="conflictexist">
...
<div class="context">
 ...
 <xsl:choose>
   <xsl:when test="$revtest=1">   <!-- Rev is active - add the DIV -->
    <div class="{@rev}"><xsl:apply-templates select="."  mode="context-fmt" /></div>
   </xsl:when>
   <xsl:otherwise>  <!-- Rev wasn't active - process normally -->
    <xsl:apply-templates select="."  mode="context-fmt" />
   </xsl:otherwise>
 </xsl:choose>
  <xsl:call-template name="end-flagit">
    <xsl:with-param name="flagrules" select="$flagrules"></xsl:with-param> 
...
<xsl:template match="*[contains(@class,' task/context ')]" mode="context-fmt">
  <xsl:variable name="flagrules">
    <xsl:call-template name="getrules"/>
  </xsl:variable>
  <xsl:call-template name="start-revflag">
...
<xsl:template match="*[contains(@class,' task/result ')]" name="task.result">
  <xsl:variable name="flagrules">
    <xsl:call-template name="getrules"/>
  </xsl:variable>
  <xsl:variable name="conflictexist">
...
<div class="taskresult">
 ...
 <xsl:choose>
   <xsl:when test="$revtest=1">   <!-- Rev is active - add the DIV -->
    <div class="{@rev}"><xsl:apply-templates select="."  mode="taskresult-fmt" /></div>
   </xsl:when>
   <xsl:otherwise>  <!-- Rev wasn't active - process normally -->
    <xsl:apply-templates select="."  mode="taskresult-fmt" />
   </xsl:otherwise>
 </xsl:choose>
  <xsl:call-template name="end-flagit">
    <xsl:with-param name="flagrules" select="$flagrules"></xsl:with-param> 
...
<xsl:template match="*[contains(@class,' task/result ')]" mode="taskresult-fmt">
  <xsl:variable name="flagrules">
    <xsl:call-template name="getrules"/>
  </xsl:variable>
  <xsl:call-template name="start-revflag">
