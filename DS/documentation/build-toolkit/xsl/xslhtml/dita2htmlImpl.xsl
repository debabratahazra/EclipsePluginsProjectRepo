...
<xsl:import href="../../DITA-OT1.4.1/xsl/common/output-message.xsl"/>
<xsl:import href="../../DITA-OT1.4.1/xsl/common/dita-utilities.xsl"/>
...
<html>
  ...
  <xsl:template name="chapterBody">
    ...
    <!--  CHM files does not support background image into stylesheets, so use obsolet background body attribute -->
    <body background="{$PATH2PROJ}{$CSSPATH}banner.jpg">
