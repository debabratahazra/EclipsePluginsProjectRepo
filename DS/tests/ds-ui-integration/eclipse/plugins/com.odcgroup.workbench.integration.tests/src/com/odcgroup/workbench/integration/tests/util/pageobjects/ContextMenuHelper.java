...
public class ContextMenuHelper {
	...
	public static void clickContextMenu(final SWTBotTreeItem bottreeitem, final String... texts) {

		// show
		final MenuItem menuItem = UIThreadRunnable.syncExec(new WidgetResult<MenuItem>() {
			public MenuItem run() {
				MenuItem menuItem = null;
				TreeItem item = (TreeItem) bottreeitem.widget;
				Menu menu = item.getParent().getMenu();
