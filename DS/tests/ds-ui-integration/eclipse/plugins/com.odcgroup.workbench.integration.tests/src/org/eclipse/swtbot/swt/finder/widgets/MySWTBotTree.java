...
public class MySWTBotTree extends MyAbstractSWTBot<Tree> {
	 ...
	 */
	public MySWTBotTree(Tree tree, SelfDescribing description) throws WidgetNotFoundException {
	 ...
	 * @throws WidgetNotFoundException if the widget is <code>null</code> or widget has been disposed.
	 */
	public MySWTBotTree(Tree tree) throws WidgetNotFoundException {
		this(tree, null);
	}
	 ...
	 */
	public MySWTBotTree select(final String... items) {
		waitForEnabled();
		setFocus();
	 ...
	 * @return this same instance.
	 */
	public MySWTBotTree select(final SWTBotTreeItem... items) {
		assertEnabled();
		setFocus();
		asyncExec(new VoidResult() {
			public void run() {
	 ...
	 * @return this same instance.
	 */
	public MySWTBotTree select(final int... indices) {
		waitForEnabled();
		setFocus();
		asyncExec(new VoidResult() {
			public void run() {
