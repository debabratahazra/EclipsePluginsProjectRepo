/*   |   *//************** TAFJ INFO ***************************************/
/*   |   *//* <TAFJ-BP>W:\svn\DS\trunk\tests\t24-packager\tafj-basic\basic\HELLO.MAVEN.b<\TAFJ-BP>  */
/*   |   *//* <TAFJ-BPA>com.temenos.t24<\TAFJ-BPA>  */
/*   |   *//* <TAFJ-BN>HELLO.MAVEN<\TAFJ-BN>  */
/*   |   *//************** TAFJ INFO ***************************************/
...
/*   |   */
/*   |   */ //PROGRAM HELLO_MAVEN_cl
/*   |   */public class HELLO_MAVEN_cl extends jRunTime {
/*   |   */    private static jRunTime __instance;
/*   |   */    
/*   |   */    private boolean _inMove = false;
/*   |   */    public HELLO_MAVEN_cl(){
/*   |   */        __instance = this;
/*   |   */    }
/*   |   */    
...
/*   |   */    
/*   |   */    protected int main(){
_l(     3);        //CALL HELLO.MAVEN.SUB
/*   |   */        HELLO_MAVEN_SUB_cl.INSTANCE(session).invoke("14.0.1");
/*   |   */        if (session.getStateSubroutineAfterCall()==STATE_EXIT){
/*   |   */            if (true) return LABEL_EXIT;  //ABORT
/*   |   */        }
...
/*   |   */                invokeRestart("HELLO_MAVEN_cl",false,  new jVar[]{});
...
/*   |   */        Environment.loadConfig(_args_);
/*   |   */        jSession session = new jSession();
/*   |   */        StringBuffer sb = new StringBuffer("HELLO_MAVEN");
/*   |   */        for (int i = 0; i < _args_.length; i++ ){
/*   |   */         	sb.append(' ').append(_args_[i]);
/*   |   */        }
/*   |   */        session.setCommand(sb.toString());
/*   |   */        try{
/*   |   */            HELLO_MAVEN_cl.INSTANCE(session).invoke();
/*   |   */        }catch(BasicRuntimeException jrte){
/*   |   */        }
...
/*   |   */        jRunTime prg = null;
/*   |   */        prg =session.getRuntimeCache("HELLO_MAVEN_cl");
/*   |   */        if (prg == null) {
/*   |   */            prg = new HELLO_MAVEN_cl();
/*   |   */            prg.init(session);
/*   |   */        }
/*   |   */        return prg;
/*   |   */    }
/*   |   */    
/*   |   */    public void stack(HELLO_MAVEN_cl prg){
/*   |   */        if (session.setRuntimeCache("HELLO_MAVEN_cl", prg)){
/*   |   */            //
...
/*   |   */        invokeStart("HELLO_MAVEN_cl",false,  new jVar[]{});
/*   |   */        int nRet = main();
/*   |   */        if (nRet > 0){
/*   |   */            CB(nRet);
/*   |   */        }else{
...
/*   |   */        }
/*   |   */        release();
/*   |   */        invokeStop("HELLO_MAVEN_cl",false,  new jVar[]{});
...
/*   |   */        return "W:\\svn\\DS\\trunk\\tests\\t24-packager\\tafj-basic\\basic\\HELLO.MAVEN.b";
/*   |   */    }
/*   |   */    
/*   |   */    //For tShow
/*   |   */    public String getCompileInfo() {
/*   |   */        return "1369846290911	29 May 2013 18:51:30	W8432	1";
/*   |   */    }
/*   |   */    
/*   |   */    //For tShow
