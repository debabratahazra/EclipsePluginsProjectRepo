...
public class DataSecurityMemoryView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		buttonRefresh.setToolTipText("Refresh Data Security Memory");
		buttonRefresh.addMouseListener(new org.eclipse.swt.events.MouseListener() {
			...
			public void mouseUp(org.eclipse.swt.events.MouseEvent e) {				
				//Update Data Security Memory view in Simulator SDK. 				
				short [] addressValue ={0x00, 0x00, 0x80};							
					Packet_ACK=IdebugInterface.readDataSecurityMemory(addressValue);					
					Packet_ACK[1]--;
		...
		buttonClose.setToolTipText("Close Data Security Memory View");
		buttonClose.addMouseListener(new org.eclipse.swt.events.MouseListener() {
			public void mouseUp(org.eclipse.swt.events.MouseEvent e) {				
				...
				findView("com.cdt.keil.debug.ui.DataSecurityMemory"));
			}
			public void mouseDoubleClick(org.eclipse.swt.events.MouseEvent e) {
			}
			public void mouseDown(org.eclipse.swt.events.MouseEvent e) {
