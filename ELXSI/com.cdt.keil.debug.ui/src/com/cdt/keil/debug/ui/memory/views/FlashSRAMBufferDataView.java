...
public class FlashSRAMBufferDataView extends ViewPart {
	...
	public FlashSRAMBufferDataView() {}
	...
	public void createPartControl(Composite parent) {
		...
		buttonRefresh.setToolTipText("Refresh Flash SRAM Buffer Data Memory View");
		buttonRefresh.addMouseListener(new org.eclipse.swt.events.MouseListener() {
			...
			public void mouseUp(org.eclipse.swt.events.MouseEvent e) {				
				//Update Flash SRAM Buffer Data Memory view in Simulator SDK.								
				short [] addressValue ={0x00, 0x00, 0x40};							
					Packet_ACK=IdebugInterface.readFlashSRAMBufferDataMemory(addressValue);					
					Packet_ACK[1]++;
		...
		buttonClose.setToolTipText("Close Flash SRAM Buffer Data Memory View");
		buttonClose.addMouseListener(new org.eclipse.swt.events.MouseListener() {
			public void mouseUp(org.eclipse.swt.events.MouseEvent e) {				
				...
				findView("com.cdt.keil.debug.ui.FlashSRAMBufferDataView"));
			}
			public void mouseDoubleClick(org.eclipse.swt.events.MouseEvent e) {
			}
			public void mouseDown(org.eclipse.swt.events.MouseEvent e) {
