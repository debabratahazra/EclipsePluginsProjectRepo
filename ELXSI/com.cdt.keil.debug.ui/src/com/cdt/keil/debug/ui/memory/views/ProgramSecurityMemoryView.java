...
public class ProgramSecurityMemoryView extends ViewPart {
	...
	public ProgramSecurityMemoryView() {		
	}
	...
	public void createPartControl(Composite parent) {
		...
		buttonRefresh.setToolTipText("Refresh Program Security Memory View");
		buttonRefresh.addMouseListener(new org.eclipse.swt.events.MouseListener() {
			...
			public void mouseUp(org.eclipse.swt.events.MouseEvent e) {				
				//Update Program Security Memory view in Simulator SDK.								
				short [] addressValue ={0x00, 0x00, 0x80};							
					Packet_ACK=IdebugInterface.readProgramSecurityMemory(addressValue);					
					Packet_ACK[1]--;
		...
		buttonClose.setToolTipText("Close Program Security Memory View");
		buttonClose.addMouseListener(new org.eclipse.swt.events.MouseListener() {
			public void mouseUp(org.eclipse.swt.events.MouseEvent e) {				
				...
				findView("com.cdt.keil.debug.ui.ProgramSecurityMemory"));
			}
			public void mouseDoubleClick(org.eclipse.swt.events.MouseEvent e) {
			}
			public void mouseDown(org.eclipse.swt.events.MouseEvent e) {
