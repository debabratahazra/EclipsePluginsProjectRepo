...
public class ProgramSecurityMemory implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {try {
		...
		page.detachView(PlatformUI.getWorkbench().getActiveWorkbenchWindow().
				getActivePage().findViewReference("com.cdt.keil.debug.ui.ProgramSecurityMemory"));*/
