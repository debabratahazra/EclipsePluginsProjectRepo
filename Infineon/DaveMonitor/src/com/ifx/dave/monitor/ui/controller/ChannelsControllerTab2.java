 ...
 *
 */
public class ChannelsControllerTab2 {

	private static final int DELTA_OFFSET = 5;

	public ChannelsControllerTab2() {

	    offsetActionChannel1(MainWindow.getController().getLinechart21(),
	            MainWindow.getController().getChannel1_up_tab2(),
	            MainWindow.getController().getChannel1_down_tab2());

	    offsetActionChannel1(MainWindow.getController().getLinechart22(),
                MainWindow.getController().getChannel2_up_tab2(),
                MainWindow.getController().getChannel2_down_tab2());

	    offsetActionChannel1(MainWindow.getController().getLinechart23(),
                MainWindow.getController().getChannel3_up_tab2(),
                MainWindow.getController().getChannel3_down_tab2());

	    offsetActionChannel1(MainWindow.getController().getLinechart24(),
                MainWindow.getController().getChannel4_up_tab2(),
                MainWindow.getController().getChannel4_down_tab2());
	}
