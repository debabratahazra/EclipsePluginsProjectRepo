 ...
 *
 */
public class ChannelsControllerTab3 {

	private static final int DELTA_OFFSET = 5;

	public ChannelsControllerTab3() {

	    offsetActionChannel1(MainWindow.getController().getLinechart31(),
	            MainWindow.getController().getChannel1_up_tab3(),
	            MainWindow.getController().getChannel1_down_tab3());

	    offsetActionChannel1(MainWindow.getController().getLinechart32(),
                MainWindow.getController().getChannel2_up_tab3(),
                MainWindow.getController().getChannel2_down_tab3());

	    offsetActionChannel1(MainWindow.getController().getLinechart33(),
                MainWindow.getController().getChannel3_up_tab3(),
                MainWindow.getController().getChannel3_down_tab3());

	    offsetActionChannel1(MainWindow.getController().getLinechart34(),
                MainWindow.getController().getChannel4_up_tab3(),
                MainWindow.getController().getChannel4_down_tab3());
	}
