 ...
 *
 */
public class ChannelsControllerTab7 {

	private static final int DELTA_OFFSET = 5;

	public ChannelsControllerTab7() {

	    offsetActionChannel1(MainWindow.getController().getLinechart71(),
	            MainWindow.getController().getChannel1_up_tab7(),
	            MainWindow.getController().getChannel1_down_tab7());

	    offsetActionChannel1(MainWindow.getController().getLinechart72(),
                MainWindow.getController().getChannel2_up_tab7(),
                MainWindow.getController().getChannel2_down_tab7());

	    offsetActionChannel1(MainWindow.getController().getLinechart73(),
                MainWindow.getController().getChannel3_up_tab7(),
                MainWindow.getController().getChannel3_down_tab7());

	    offsetActionChannel1(MainWindow.getController().getLinechart74(),
                MainWindow.getController().getChannel4_up_tab7(),
                MainWindow.getController().getChannel4_down_tab7());
	}
