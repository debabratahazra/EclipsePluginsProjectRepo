...
public class LineChartControllerTab2 {
	...
	/** Constructor */
	public LineChartControllerTab2() throws Exception {
		lineChart_Ch1 = MainWindow.getController().getLinechart21();
		lineChart_Ch2 = MainWindow.getController().getLinechart22();
		lineChart_Ch3 = MainWindow.getController().getLinechart23();
		lineChart_Ch4 = MainWindow.getController().getLinechart24();
	...
	private void zoomFunctionality() {
		...
		}, MainWindow.getController().getStackpane2(), lineChart_Ch1, lineChart_Ch2, lineChart_Ch3, lineChart_Ch4 );
	}
	...
	public AnimationTimer getTimerTab2() {
		return timer;
