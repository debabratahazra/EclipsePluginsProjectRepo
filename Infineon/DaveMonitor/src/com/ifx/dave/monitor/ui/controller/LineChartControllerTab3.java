...
public class LineChartControllerTab3 {
	...
	/** Constructor */
	public LineChartControllerTab3() throws Exception {
		lineChart_Ch1 = MainWindow.getController().getLinechart31();
		lineChart_Ch2 = MainWindow.getController().getLinechart32();
		lineChart_Ch3 = MainWindow.getController().getLinechart33();
		lineChart_Ch4 = MainWindow.getController().getLinechart34();
	...
	private void zoomFunctionality() {
		...
		}, MainWindow.getController().getStackpane3(), lineChart_Ch1, lineChart_Ch2, lineChart_Ch3, lineChart_Ch4 );
	}
	...
	public AnimationTimer getTimerTab3() {
		return timer;
            ...
            @Override
                    public void handle(MouseEvent t) {
                        ...
                        if (t.getButton() == MouseButton.SECONDARY) {
                            ...
                            autoZoom.setOnAction(new EventHandler<ActionEvent>() {

                                @Override
                                public void handle(ActionEvent event) {
                                    AutoZoomLineChart.fitToScene(lineChart_Ch1, lineChart_Ch2, lineChart_Ch3, lineChart_Ch4, MAX_POINTS);
                                    contextMenu.hide();
                                }
                            });
