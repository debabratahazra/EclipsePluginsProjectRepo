...
public class LineChartControllerTab4 {
	...
	/** Constructor */
	public LineChartControllerTab4() throws Exception {
		lineChart_Ch1 = MainWindow.getController().getLinechart41();
		lineChart_Ch2 = MainWindow.getController().getLinechart42();
		lineChart_Ch3 = MainWindow.getController().getLinechart43();
		lineChart_Ch4 = MainWindow.getController().getLinechart44();
	...
	private void zoomFunctionality() {
		...
		}, MainWindow.getController().getStackpane4(), lineChart_Ch1, lineChart_Ch2, lineChart_Ch3, lineChart_Ch4 );
	}
	...
	public AnimationTimer getTimer_Tab4() {
		return timer;
