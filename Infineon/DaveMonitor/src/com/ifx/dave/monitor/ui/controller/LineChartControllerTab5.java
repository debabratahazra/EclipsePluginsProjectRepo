...
public class LineChartControllerTab5 {
	...
	/** Constructor */
	public LineChartControllerTab5() throws Exception {
		lineChart_Ch1 = MainWindow.getController().getLinechart51();
		lineChart_Ch2 = MainWindow.getController().getLinechart52();
		lineChart_Ch3 = MainWindow.getController().getLinechart53();
		lineChart_Ch4 = MainWindow.getController().getLinechart54();
	...
	private void zoomFunctionality() {
		...
		}, MainWindow.getController().getStackpane5(), lineChart_Ch1, lineChart_Ch2, lineChart_Ch3, lineChart_Ch4 );
	}
	...
	public AnimationTimer getTimer_tab5() {
		return timer;
