...
public class LineChartControllerTab7 {
	...
	/** Constructor */
	public LineChartControllerTab7() throws Exception {
		lineChart_Ch1 = MainWindow.getController().getLinechart71();
		lineChart_Ch2 = MainWindow.getController().getLinechart72();
		lineChart_Ch3 = MainWindow.getController().getLinechart73();
		lineChart_Ch4 = MainWindow.getController().getLinechart74();
	...
	private void zoomFunctionality() {
		...
		}, MainWindow.getController().getStackpane7(), lineChart_Ch1, lineChart_Ch2, lineChart_Ch3, lineChart_Ch4 );
	}
	...
	public AnimationTimer getTimer_tab7() {
		return timer;
