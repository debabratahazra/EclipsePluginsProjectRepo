...
public class LineChartControllerTab8 {
	...
	/** Constructor */
	public LineChartControllerTab8() throws Exception {
		lineChart_Ch1 = MainWindow.getController().getLinechart81();
		lineChart_Ch2 = MainWindow.getController().getLinechart82();
		lineChart_Ch3 = MainWindow.getController().getLinechart83();
		lineChart_Ch4 = MainWindow.getController().getLinechart84();
	...
	private void zoomFunctionality() {
		...
		}, MainWindow.getController().getStackpane8(), lineChart_Ch1, lineChart_Ch2, lineChart_Ch3, lineChart_Ch4 );
	}
	...
	public AnimationTimer getTimerTab8() {
		return timer;
