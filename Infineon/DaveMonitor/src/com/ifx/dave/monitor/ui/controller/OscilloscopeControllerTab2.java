 ...
 *
 */
public class OscilloscopeControllerTab2 {

    public OscilloscopeControllerTab2() {
        executeRun_Stop();
    }

    private void executeRun_Stop() {
        final ToggleButton runToggleBtn = MainWindow.getController().getRuntoggle_tab2();
        final AnimationTimer timer = MainWindow.getController().getLineChartControllerTab2().getTimerTab2();
