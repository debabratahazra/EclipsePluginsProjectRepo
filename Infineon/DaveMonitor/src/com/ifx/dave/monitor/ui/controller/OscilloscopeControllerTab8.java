 ...
 *
 */
public class OscilloscopeControllerTab8 {

    public OscilloscopeControllerTab8() {
        executeRun_Stop();
    }

    private void executeRun_Stop() {
        final ToggleButton runToggleBtn = MainWindow.getController().getRuntoggle_tab8();
        final AnimationTimer timer = MainWindow.getController().getLineChartControllerTab8().getTimerTab8();
