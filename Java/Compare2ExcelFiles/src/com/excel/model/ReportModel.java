...
public class ReportModel implements Comparable<ReportModel> {
    ...
    public int compareTo(ReportModel reportModel) {
        return this.cusip.compareTo(reportModel.cusip);
    }

    @Override
    public int hashCode() {
        return this.trade_id.hashCode();
    }

    public static int MATCHED_INDEX = -1;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.cusip.equalsIgnoreCase(resultModel.getCusip())
                && this.instmt_id.equalsIgnoreCase(resultModel.getInstmt_id())
                && this.postn.equalsIgnoreCase(resultModel.getPostn())
                && this.trade_id.equals(resultModel.getTrade_id())) {
        	MATCHED_INDEX = resultModel.getIndex();
            return true;
        }
        MATCHED_INDEX = -1;
        return false;
