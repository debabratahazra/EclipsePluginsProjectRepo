...
public class OsePmdBinImporterTest extends AbstractImporterTest {
    ...
    private static final String TESTFILE_BIN_URL = "logs/events-small.pmd";

    private static final String TESTFILE_BIN_OUT_URL = "logs/events-small.bin";
    ...
    public void testCanRead() {
        File testfile = new File(TESTFILE_BIN_URL);
    ...
    protected File getFileInput() {
        ...
        return new File(TESTFILE_BIN_URL);
    }
