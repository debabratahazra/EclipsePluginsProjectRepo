...
public class ImplementIFile implements IFile {
	
	private ImplementIContainer impCon;
	
	public ImplementIFile(){
		
		impCon = new ImplementIContainer();
	}
