...
public class SearchPreferences extends PreferencePage implements
IWorkbenchPreferencePage {

    private Text textbox;

    private static final String SEARCH_HITS = "search_hits";

    public SearchPreferences() {}

    public SearchPreferences(final String title) {
        super(title);
    }

    public SearchPreferences(final String title, final ImageDescriptor image) {
        super(title, image);
    }
    ...
    protected Control createContents(final Composite parent) {
        ...
        eventsGroup.setText("Search Option");
        ...
        textbox.setText(String.valueOf(SeUiPlugin.getDefault().getPreferenceStore().getInt(SEARCH_HITS)));
        ...
        textbox.addModifyListener(new ModifyListener(){
            ...
            public void modifyText(final ModifyEvent e) {
                ...
                }else if(Long.valueOf(textbox.getText()).longValue() < Long.valueOf(SearchQuery.MIN_SEARCH_LIMIT).longValue()){
                    setValid(false);
                    setErrorMessage("Value must be greater or equal to " + SearchQuery.MIN_SEARCH_LIMIT);
                }else{
                    setValid(true);
    ...
    protected void performApply() {
        SeUiPlugin.getDefault().getPreferenceStore().setValue(SEARCH_HITS,
    ...
    protected void performDefaults() {
        textbox.setText(String.valueOf(SearchQuery.MIN_SEARCH_LIMIT));
        getApplyButton().setEnabled(true);
    }

    public void init(final IWorkbench workbench) {
        SeUiPlugin.getDefault().getPreferenceStore().setDefault(SEARCH_HITS,
                SearchQuery.MIN_SEARCH_LIMIT);
    }
