...
/**
 * Color provider that returns a single, random generated, color.
 *
 */
public class RandomColorProviderItems implements ChartColorProvider
{
   ColorRGBA color;
   
   public RandomColorProviderItems()
   {
      ...
      color = new ColorRGBA(red, green, blue);
   }
