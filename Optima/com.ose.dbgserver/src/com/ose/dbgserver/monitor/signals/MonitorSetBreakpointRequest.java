...
public class MonitorSetBreakpointRequest extends Signal
{
   public static final int SIG_NO = 39122;
   ...
   public MonitorSetBreakpointRequest()
   {
      super(SIG_NO);
   }

   public MonitorSetBreakpointRequest(int pid, int address, int scopeType,
         int scopeId, int interceptType, int interceptId, MonitorTag[] tags)
   {
      super(SIG_NO);
      this.pid = pid;
