...
public class DBGCatchCreateKillNotify extends Message implements dbgserverinterfaceConstants{
   public short state;
   ...
   public DBGCatchCreateKillNotify(short _state, byte _eventType, byte _notUsed, int _procType, int _bid, int _tick, int _utick, int _abstime, int _abstick, int _creatorPid, int _pid, String _name) {
      state = _state;
   ...
   public DBGCatchCreateKillNotify(DataInputStream _s) throws IOException { signalNo = 32945; read(_s);}
   ...
   public final static void write(DataOutputStream _s, short _state, byte _eventType, byte _notUsed, int _procType, int _bid, int _tick, int _utick, int _abstime, int _abstick, int _creatorPid, int _pid, String _name   ) throws IOException {
         ...
         _s.writeInt(DBGCATCHCREATEKILLNOTIFY);
         int _size=44
            +4+_nameSize
            ;
         _s.writeInt(_size);
