...
public class DBGCatchSwapNotify extends Message implements dbgserverinterfaceConstants{
   public short state;
   ...
   public DBGCatchSwapNotify(short _state, short _notUsed, int _tick, int _utick, int _abstime, int _abstick, int _fromPid, int _toPid, String _fromName, String _toName) {
      state = _state;
      notUsed = _notUsed;
      tick = _tick;
      utick = _utick;
   ...
   public DBGCatchSwapNotify(DataInputStream _s) throws IOException { signalNo = 32946; read(_s);}
   public final void sendMessage(DataOutputStream _s) throws IOException { write(_s, this.state, this.notUsed, this.tick, this.utick, this.abstime, this.abstick, this.fromPid, this.toPid, this.fromName, this.toName);}
   public final static void write(DataOutputStream _s, short _state, short _notUsed, int _tick, int _utick, int _abstime, int _abstick, int _fromPid, int _toPid, String _fromName, String _toName   ) throws IOException {
         int _i;
         int _fromNameSize=_fromName.length()+1;
         int _toNameSize=_toName.length()+1;
         _s.writeInt(DBGCATCHSWAPNOTIFY);
         int _size=36
