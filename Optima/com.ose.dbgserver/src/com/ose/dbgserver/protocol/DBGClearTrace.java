...
public class DBGClearTrace extends Message implements dbgserverinterfaceConstants{


   public DBGClearTrace() {
   }

   public DBGClearTrace(DataInputStream _s) throws IOException { signalNo = 32935; read(_s);}
