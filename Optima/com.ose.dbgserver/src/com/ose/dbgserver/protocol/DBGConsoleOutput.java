...
public class DBGConsoleOutput extends Message implements dbgserverinterfaceConstants{
   public byte buffer[];


   public DBGConsoleOutput(byte _buffer[]) {
      buffer = _buffer;
   }

   public DBGConsoleOutput(DataInputStream _s) throws IOException { signalNo = 33051; read(_s);}
