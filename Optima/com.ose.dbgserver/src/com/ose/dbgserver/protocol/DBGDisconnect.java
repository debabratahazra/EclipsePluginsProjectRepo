...
public class DBGDisconnect extends Message implements dbgserverinterfaceConstants{


   public DBGDisconnect() {
   }

   public DBGDisconnect(DataInputStream _s) throws IOException { signalNo = 32906; read(_s);}
