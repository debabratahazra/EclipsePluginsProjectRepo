...
public class DBGEnableEvacts extends Message implements dbgserverinterfaceConstants{


   public DBGEnableEvacts() {
   }

   public DBGEnableEvacts(DataInputStream _s) throws IOException { signalNo = 32916; read(_s);}
