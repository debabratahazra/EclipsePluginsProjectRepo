...
public class DBGGetCPUMeasurementStatus extends Message implements dbgserverinterfaceConstants{


   public DBGGetCPUMeasurementStatus() {
   }

   public DBGGetCPUMeasurementStatus(DataInputStream _s) throws IOException { signalNo = 32996; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGGETCPUMEASUREMENTSTATUS);
         int _size=8;
         _s.writeInt(_size);
   }
