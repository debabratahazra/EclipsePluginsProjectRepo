...
public class DBGGetCPUMeasurementStatusReply extends Message implements dbgserverinterfaceConstants{
   ...
   public DBGGetCPUMeasurementStatusReply(int _measurementStatus, int _uInterval, int _currentTimeTick, int _currentTimeUTick) {
   ...
   public DBGGetCPUMeasurementStatusReply(DataInputStream _s) throws IOException { signalNo = 32997; read(_s);}
   ...
   public final static void write(DataOutputStream _s, int _measurementStatus, int _uInterval, int _currentTimeTick, int _currentTimeUTick   ) throws IOException {
         int _i;
         _s.writeInt(DBGGETCPUMEASUREMENTSTATUSREPLY);
         int _size=24;
         _s.writeInt(_size);
