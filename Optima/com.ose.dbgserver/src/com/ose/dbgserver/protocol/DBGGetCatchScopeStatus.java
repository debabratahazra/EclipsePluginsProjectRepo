...
public class DBGGetCatchScopeStatus extends Message implements dbgserverinterfaceConstants{


   public DBGGetCatchScopeStatus() {
   }

   public DBGGetCatchScopeStatus(DataInputStream _s) throws IOException { signalNo = 32949; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGGETCATCHSCOPESTATUS);
         int _size=8;
         _s.writeInt(_size);
   }
