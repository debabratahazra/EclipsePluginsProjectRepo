...
public class DBGGetCurrentProcess extends Message implements dbgserverinterfaceConstants{


   public DBGGetCurrentProcess() {
   }

   public DBGGetCurrentProcess(DataInputStream _s) throws IOException { signalNo = 33062; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGGETCURRENTPROCESS);
         int _size=8;
         _s.writeInt(_size);
   }
