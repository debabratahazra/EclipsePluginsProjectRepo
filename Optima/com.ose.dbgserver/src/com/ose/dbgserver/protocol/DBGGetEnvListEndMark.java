...
public class DBGGetEnvListEndMark extends Message implements dbgserverinterfaceConstants{
   public int pid;


   public DBGGetEnvListEndMark(int _pid) {
      pid = _pid;
   }

   public DBGGetEnvListEndMark(DataInputStream _s) throws IOException { signalNo = 32971; read(_s);}
   ...
   public final static void write(DataOutputStream _s, int _pid   ) throws IOException {
         int _i;
         _s.writeInt(DBGGETENVLISTENDMARK);
         int _size=12;
         _s.writeInt(_size);
         _s.writeInt(_pid);
   }
