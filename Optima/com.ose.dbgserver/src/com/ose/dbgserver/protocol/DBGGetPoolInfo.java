...
public class DBGGetPoolInfo extends Message implements dbgserverinterfaceConstants{
   public int pid;


   public DBGGetPoolInfo(int _pid) {
      pid = _pid;
   }

   public DBGGetPoolInfo(DataInputStream _s) throws IOException { signalNo = 32951; read(_s);}
