...
public class DBGGetPriLoadReports extends Message implements dbgserverinterfaceConstants{
   public int receivedTimeTick;
   public int receivedTimeUTick;
   public short count;


   public DBGGetPriLoadReports(int _receivedTimeTick, int _receivedTimeUTick, short _count) {
      receivedTimeTick = _receivedTimeTick;
      receivedTimeUTick = _receivedTimeUTick;
      count = _count;
   }

   public DBGGetPriLoadReports(DataInputStream _s) throws IOException { signalNo = 33009; read(_s);}
   ...
   public final static void write(DataOutputStream _s, int _receivedTimeTick, int _receivedTimeUTick, short _count   ) throws IOException {
         int _i;
         _s.writeInt(DBGGETPRILOADREPORTS);
         int _size=18;
         _s.writeInt(_size);
