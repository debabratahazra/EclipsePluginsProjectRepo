...
public class DBGGetPriMeasurementStatusReply extends Message implements dbgserverinterfaceConstants{
   ...
   public DBGGetPriMeasurementStatusReply(int _measurementStatus, int _uInterval, int _currentTimeTick, int _currentTimeUTick) {
   ...
   public DBGGetPriMeasurementStatusReply(DataInputStream _s) throws IOException { signalNo = 32999; read(_s);}
   ...
   public final static void write(DataOutputStream _s, int _measurementStatus, int _uInterval, int _currentTimeTick, int _currentTimeUTick   ) throws IOException {
         int _i;
         _s.writeInt(DBGGETPRIMEASUREMENTSTATUSREPLY);
         int _size=24;
         _s.writeInt(_size);
