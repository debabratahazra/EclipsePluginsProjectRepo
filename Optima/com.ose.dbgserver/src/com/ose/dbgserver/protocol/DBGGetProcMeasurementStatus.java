...
public class DBGGetProcMeasurementStatus extends Message implements dbgserverinterfaceConstants{


   public DBGGetProcMeasurementStatus() {
   }

   public DBGGetProcMeasurementStatus(DataInputStream _s) throws IOException { signalNo = 33002; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGGETPROCMEASUREMENTSTATUS);
         int _size=8;
         _s.writeInt(_size);
   }
