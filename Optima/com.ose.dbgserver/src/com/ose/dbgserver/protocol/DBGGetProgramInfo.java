...
public class DBGGetProgramInfo extends Message implements dbgserverinterfaceConstants{


   public DBGGetProgramInfo() {
   }

   public DBGGetProgramInfo(DataInputStream _s) throws IOException { signalNo = 33042; read(_s);}
