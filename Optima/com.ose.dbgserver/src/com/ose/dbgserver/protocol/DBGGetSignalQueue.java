...
public class DBGGetSignalQueue extends Message implements dbgserverinterfaceConstants{
   public int pid;


   public DBGGetSignalQueue(int _pid) {
      pid = _pid;
   }

   public DBGGetSignalQueue(DataInputStream _s) throws IOException { signalNo = 32982; read(_s);}
