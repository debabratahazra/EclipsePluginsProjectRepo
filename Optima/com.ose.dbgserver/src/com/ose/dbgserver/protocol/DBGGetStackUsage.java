...
public class DBGGetStackUsage extends Message implements dbgserverinterfaceConstants{
   public int pid;


   public DBGGetStackUsage(int _pid) {
      pid = _pid;
   }

   public DBGGetStackUsage(DataInputStream _s) throws IOException { signalNo = 32967; read(_s);}
