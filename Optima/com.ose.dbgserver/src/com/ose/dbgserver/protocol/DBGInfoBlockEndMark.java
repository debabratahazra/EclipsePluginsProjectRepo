...
public class DBGInfoBlockEndMark extends Message implements dbgserverinterfaceConstants{


   public DBGInfoBlockEndMark() {
   }

   public DBGInfoBlockEndMark(DataInputStream _s) throws IOException { signalNo = 32966; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGINFOBLOCKENDMARK);
         int _size=8;
         _s.writeInt(_size);
   }
