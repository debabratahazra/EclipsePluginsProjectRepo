...
public class DBGInfoCPULoadReportsEndMark extends Message implements dbgserverinterfaceConstants{


   public DBGInfoCPULoadReportsEndMark() {
   }

   public DBGInfoCPULoadReportsEndMark(DataInputStream _s) throws IOException { signalNo = 33008; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGINFOCPULOADREPORTSENDMARK);
         int _size=8;
         _s.writeInt(_size);
   }
