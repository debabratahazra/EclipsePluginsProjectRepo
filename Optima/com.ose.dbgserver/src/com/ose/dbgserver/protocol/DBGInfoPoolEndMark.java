...
public class DBGInfoPoolEndMark extends Message implements dbgserverinterfaceConstants{


   public DBGInfoPoolEndMark() {
   }

   public DBGInfoPoolEndMark(DataInputStream _s) throws IOException { signalNo = 32953; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGINFOPOOLENDMARK);
         int _size=8;
         _s.writeInt(_size);
   }
