...
public class DBGInfoProcLoadReportsEndMark extends Message implements dbgserverinterfaceConstants{


   public DBGInfoProcLoadReportsEndMark() {
   }

   public DBGInfoProcLoadReportsEndMark(DataInputStream _s) throws IOException { signalNo = 33014; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGINFOPROCLOADREPORTSENDMARK);
         int _size=8;
         _s.writeInt(_size);
   }
