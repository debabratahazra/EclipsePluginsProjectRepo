...
public class DBGInfoProgramEndMark extends Message implements dbgserverinterfaceConstants{


   public DBGInfoProgramEndMark() {
   }

   public DBGInfoProgramEndMark(DataInputStream _s) throws IOException { signalNo = 33044; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGINFOPROGRAMENDMARK);
         int _size=8;
         _s.writeInt(_size);
   }
