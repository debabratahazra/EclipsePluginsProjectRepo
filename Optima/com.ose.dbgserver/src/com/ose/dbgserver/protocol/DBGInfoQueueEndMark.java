...
public class DBGInfoQueueEndMark extends Message implements dbgserverinterfaceConstants{
   public int pid;


   public DBGInfoQueueEndMark(int _pid) {
      pid = _pid;
   }

   public DBGInfoQueueEndMark(DataInputStream _s) throws IOException { signalNo = 32984; read(_s);}
   ...
   public final static void write(DataOutputStream _s, int _pid   ) throws IOException {
         int _i;
         _s.writeInt(DBGINFOQUEUEENDMARK);
         int _size=12;
         _s.writeInt(_size);
         _s.writeInt(_pid);
   }
