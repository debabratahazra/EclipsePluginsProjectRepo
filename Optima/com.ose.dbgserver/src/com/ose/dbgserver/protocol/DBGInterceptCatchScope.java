...
public class DBGInterceptCatchScope extends Message implements dbgserverinterfaceConstants{


   public DBGInterceptCatchScope() {
   }

   public DBGInterceptCatchScope(DataInputStream _s) throws IOException { signalNo = 32980; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGINTERCEPTCATCHSCOPE);
         int _size=8;
         _s.writeInt(_size);
   }
