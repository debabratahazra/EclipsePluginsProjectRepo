...
public class DBGInterceptProcess extends Message implements dbgserverinterfaceConstants{
   public int pid;


   public DBGInterceptProcess(int _pid) {
      pid = _pid;
   }

   public DBGInterceptProcess(DataInputStream _s) throws IOException { signalNo = 32978; read(_s);}
   ...
   public final static void write(DataOutputStream _s, int _pid   ) throws IOException {
         int _i;
         _s.writeInt(DBGINTERCEPTPROCESS);
         int _size=12;
         _s.writeInt(_size);
         _s.writeInt(_pid);
   }
