...
public class DBGKillProcess extends Message implements dbgserverinterfaceConstants{
   public int pid;


   public DBGKillProcess(int _pid) {
      pid = _pid;
   }

   public DBGKillProcess(DataInputStream _s) throws IOException { signalNo = 32975; read(_s);}
