...
public class DBGLock extends Message implements dbgserverinterfaceConstants{


   public DBGLock() {
   }

   public DBGLock(DataInputStream _s) throws IOException { signalNo = 32911; read(_s);}
