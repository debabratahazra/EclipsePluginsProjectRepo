...
public class DBGMonitorDisable extends Message implements dbgserverinterfaceConstants{


   public DBGMonitorDisable() {
   }

   public DBGMonitorDisable(DataInputStream _s) throws IOException { signalNo = 32958; read(_s);}
