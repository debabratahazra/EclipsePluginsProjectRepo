...
public class DBGNotifyReply extends Message implements dbgserverinterfaceConstants{
   public int status;


   public DBGNotifyReply(int _status) {
      status = _status;
   }

   public DBGNotifyReply(DataInputStream _s) throws IOException { signalNo = 33047; read(_s);}
