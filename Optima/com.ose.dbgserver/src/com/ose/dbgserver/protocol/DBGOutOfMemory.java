...
public class DBGOutOfMemory extends Message implements dbgserverinterfaceConstants{


   public DBGOutOfMemory() {
   }

   public DBGOutOfMemory(DataInputStream _s) throws IOException { signalNo = 32918; read(_s);}
