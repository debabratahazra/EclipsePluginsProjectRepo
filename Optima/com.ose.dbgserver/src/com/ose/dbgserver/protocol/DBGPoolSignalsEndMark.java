...
public class DBGPoolSignalsEndMark extends Message implements dbgserverinterfaceConstants{
   public int pid;


   public DBGPoolSignalsEndMark(int _pid) {
      pid = _pid;
   }

   public DBGPoolSignalsEndMark(DataInputStream _s) throws IOException { signalNo = 32956; read(_s);}
   ...
   public final static void write(DataOutputStream _s, int _pid   ) throws IOException {
         int _i;
         _s.writeInt(DBGPOOLSIGNALSENDMARK);
         int _size=12;
         _s.writeInt(_size);
         _s.writeInt(_pid);
   }
