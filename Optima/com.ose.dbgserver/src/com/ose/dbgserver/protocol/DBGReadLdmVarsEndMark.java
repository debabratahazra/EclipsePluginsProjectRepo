...
public class DBGReadLdmVarsEndMark extends Message implements dbgserverinterfaceConstants{


   public DBGReadLdmVarsEndMark() {
   }

   public DBGReadLdmVarsEndMark(DataInputStream _s) throws IOException { signalNo = 33061; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGREADLDMVARSENDMARK);
         int _size=8;
         _s.writeInt(_size);
   }
