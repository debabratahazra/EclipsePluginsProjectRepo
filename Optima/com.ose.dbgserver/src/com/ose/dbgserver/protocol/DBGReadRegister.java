...
public class DBGReadRegister extends Message implements dbgserverinterfaceConstants{
   public int pid;
   public int regVal[];


   public DBGReadRegister(int _pid, int _regVal[]) {
      pid = _pid;
      regVal = _regVal;
   }

   public DBGReadRegister(DataInputStream _s) throws IOException { signalNo = 33024; read(_s);}
