...
public class DBGResumeCatchScope extends Message implements dbgserverinterfaceConstants{


   public DBGResumeCatchScope() {
   }

   public DBGResumeCatchScope(DataInputStream _s) throws IOException { signalNo = 32981; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGRESUMECATCHSCOPE);
         int _size=8;
         _s.writeInt(_size);
   }
