...
public class DBGResumeScopeReply extends Message implements dbgserverinterfaceConstants{
   public int status;


   public DBGResumeScopeReply(int _status) {
      status = _status;
   }

   public DBGResumeScopeReply(DataInputStream _s) throws IOException { signalNo = 33041; read(_s);}
   ...
   public final static void write(DataOutputStream _s, int _status   ) throws IOException {
         int _i;
         _s.writeInt(DBGRESUMESCOPEREPLY);
         int _size=12;
         _s.writeInt(_size);
         _s.writeInt(_status);
   }
