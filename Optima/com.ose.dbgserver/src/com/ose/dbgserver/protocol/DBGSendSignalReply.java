...
public class DBGSendSignalReply extends Message implements dbgserverinterfaceConstants{


   public DBGSendSignalReply() {
   }

   public DBGSendSignalReply(DataInputStream _s) throws IOException { signalNo = 32991; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGSENDSIGNALREPLY);
         int _size=8;
         _s.writeInt(_size);
   }
