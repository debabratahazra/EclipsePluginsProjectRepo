...
public class DBGSetReceiveEvact extends Message implements dbgserverinterfaceConstants{
   public int action;
   ...
   public DBGSetReceiveEvact(int _action, int _countNumber, int _state, int _nextState, int _withSignalData, int _fromSignalNumber, int _toSignalNumber, byte _fromName[], byte _toName[]) {
      action = _action;
   ...
   public DBGSetReceiveEvact(DataInputStream _s) throws IOException { signalNo = 32920; read(_s);}
   ...
   public final static void write(DataOutputStream _s, int _action, int _countNumber, int _state, int _nextState, int _withSignalData, int _fromSignalNumber, int _toSignalNumber, byte _fromName[], byte _toName[]   ) throws IOException {
         int _i;
         _s.writeInt(DBGSETRECEIVEEVACT);
         int _size=36
