...
public class DBGSetSwapEvact extends Message implements dbgserverinterfaceConstants{
   public int action;
   ...
   public DBGSetSwapEvact(int _action, int _countNumber, int _state, int _nextState, byte _fromName[], byte _toName[]) {
      action = _action;
   ...
   public DBGSetSwapEvact(DataInputStream _s) throws IOException { signalNo = 32921; read(_s);}
   public final void sendMessage(DataOutputStream _s) throws IOException { write(_s, this.action, this.countNumber, this.state, this.nextState, this.fromName, this.toName);}
   public final static void write(DataOutputStream _s, int _action, int _countNumber, int _state, int _nextState, byte _fromName[], byte _toName[]   ) throws IOException {
         int _i;
         _s.writeInt(DBGSETSWAPEVACT);
         int _size=24
