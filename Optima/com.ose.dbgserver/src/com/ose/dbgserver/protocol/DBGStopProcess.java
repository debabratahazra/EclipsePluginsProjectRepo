...
public class DBGStopProcess extends Message implements dbgserverinterfaceConstants{
   public int pid;


   public DBGStopProcess(int _pid) {
      pid = _pid;
   }

   public DBGStopProcess(DataInputStream _s) throws IOException { signalNo = 32977; read(_s);}
