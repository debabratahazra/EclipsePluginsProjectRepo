...
public class DBGTraceDisable extends Message implements dbgserverinterfaceConstants{


   public DBGTraceDisable() {
   }

   public DBGTraceDisable(DataInputStream _s) throws IOException { signalNo = 32934; read(_s);}
