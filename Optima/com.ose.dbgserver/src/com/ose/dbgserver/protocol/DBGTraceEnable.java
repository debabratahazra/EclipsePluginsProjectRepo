...
public class DBGTraceEnable extends Message implements dbgserverinterfaceConstants{


   public DBGTraceEnable() {
   }

   public DBGTraceEnable(DataInputStream _s) throws IOException { signalNo = 32933; read(_s);}
