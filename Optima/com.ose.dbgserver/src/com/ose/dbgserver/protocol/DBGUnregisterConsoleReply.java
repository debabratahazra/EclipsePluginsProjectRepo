...
public class DBGUnregisterConsoleReply extends Message implements dbgserverinterfaceConstants{


   public DBGUnregisterConsoleReply() {
   }

   public DBGUnregisterConsoleReply(DataInputStream _s) throws IOException { signalNo = 33056; read(_s);}
   ...
   public final static void write(DataOutputStream _s   ) throws IOException {
         int _i;
         _s.writeInt(DBGUNREGISTERCONSOLEREPLY);
         int _size=8;
         _s.writeInt(_size);
   }
