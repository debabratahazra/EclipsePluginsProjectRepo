...
public class EventPerspective implements IPerspectiveFactory
{
   public void createInitialLayout(IPageLayout layout)
   {
      ...
      bottom.addView(EventPlugin.EVENT_VIEW_ID);
      ...
      layout.addShowViewShortcut(EventPlugin.EVENT_VIEW_ID);
