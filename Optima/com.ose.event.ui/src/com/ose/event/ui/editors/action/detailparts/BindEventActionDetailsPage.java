...
public class BindEventActionDetailsPage extends EventActionDetailsPage
{
   public BindEventActionDetailsPage(DocumentModel model, String actionType)
   {
   ...
   {
      createEventRow(toolkit, parent, EventActionStrings.EVENTS_GRP4);
