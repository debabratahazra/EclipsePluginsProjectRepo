...
public class ProcessEventActionDetailsPage extends EventActionDetailsPage
{

   public ProcessEventActionDetailsPage(DocumentModel model, String actionType)
   {
   ...
   {
      createEventRow(toolkit, parent, EventActionStrings.EVENTS_GRP2);
