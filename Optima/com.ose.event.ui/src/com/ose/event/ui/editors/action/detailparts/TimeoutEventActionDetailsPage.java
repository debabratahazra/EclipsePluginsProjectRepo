...
public class TimeoutEventActionDetailsPage extends EventActionDetailsPage
{
   public TimeoutEventActionDetailsPage(DocumentModel model, String actionType)
   {
   ...
   {
      createEventRow(toolkit, parent, EventActionStrings.EVENTS_GRP6);
