...
public class SerialGatewayPlugin extends AbstractUIPlugin
{
   public static final String PLUGIN_ID = "com.ose.gateway.serial";

   private static SerialGatewayPlugin plugin;

   public SerialGatewayPlugin()
   {
      plugin = this;
   }

   public static SerialGatewayPlugin getDefault()
   {
      return plugin;
   }
