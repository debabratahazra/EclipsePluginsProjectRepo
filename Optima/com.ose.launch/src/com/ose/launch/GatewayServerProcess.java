...
// FIXME: Terminate the GatewayServerProcess if its GatewayServer dies.
public class GatewayServerProcess implements IProcess
{
   ...
   public GatewayServerProcess(GatewayServer gatewayServer,
                               Dump dump,
                               File tempFile,
                               ILaunch launch,
                               String label)
