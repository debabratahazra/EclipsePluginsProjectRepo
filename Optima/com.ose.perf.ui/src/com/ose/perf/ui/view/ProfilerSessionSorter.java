   ...
   public int compare(Viewer viewer, Object e1, Object e2)
   {
      ...
      switch (column)
      {
         ...
         case ProfilerView.COLUMN_PROFILER_SESSION_EXECUTION_UNIT:
            return compareUnsignedShorts(profilerSession1.getExecutionUnit(),
                                         profilerSession2.getExecutionUnit());
         case ProfilerView.COLUMN_PROFILER_SESSION_PERFORMANCE_COUNTER:
            return compareStrings(profilerSession1.getPerformanceCounter().getName(),
                                  profilerSession2.getPerformanceCounter().getName());
         case ProfilerView.COLUMN_PROFILER_SESSION_PERFORMANCE_COUNTER_VALUE:
            return compareUnsignedLongs(profilerSession1.getPerformanceCounterValue(),
                                        profilerSession2.getPerformanceCounterValue());
         ...
         case ProfilerView.COLUMN_PROFILER_SESSION_REPORTS:
            return compareUnsignedInts(profilerSession1.getNumReports(),
                                       profilerSession2.getNumReports());
         case ProfilerView.COLUMN_PROFILER_SESSION_LOST_REPORTS:
            return compareUnsignedInts(profilerSession1.getNumLostReports(),
                                       profilerSession2.getNumLostReports());
         default:
            return 0;
      }
   }
