...
public class ShowProfilerActionDelegate implements IViewActionDelegate
{
   private static final String PROFILER_PERSPECTIVE_ID =
         "com.ose.perf.ui.ProfilerPerspective";

   private static final String PREF_SWITCH_PROFILER_PERSPECTIVE =
         "pref_switch_source_profiler_perspective";

   private static final String SWITCH_PROFILER_PERSPECTIVE_MESSAGE =
         "The Source Profiler can be opened in the current perspective " +
         "or in its own Source Profiling perspective.\n\nDo you want to " +
         "open the Source Profiler in the Source Profiling perspective?";
