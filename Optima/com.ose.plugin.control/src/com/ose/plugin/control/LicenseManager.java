...
public final class LicenseManager
{
   ...
   private LicenseManager()
   {
      ...
      pluginMap.put("com.ose.cdt.launch",
         new License(createKey(106, 66, 71, 66, 76, 117, 53, 100, 97, 99)));
      pluginMap.put("com.ose.system.ui",
         new License(createKey(89, 110, 78, 97, 77, 118, 101, 69, 80, 100)));
      pluginMap.put("com.ose.ck.system.ui",
         new License(createKey(115, 73, 114, 107, 56, 50, 52, 68, 87, 85)));
      pluginMap.put("com.ose.pmd",
         new License(createKey(88, 78, 120, 110, 106, 56, 54, 107, 103, 103)));
      pluginMap.put("com.ose.event.ui",
         new License(createKey(77, 87, 49, 71, 114, 120, 87, 77, 52, 101)));
      pluginMap.put("com.ose.prof.ui",
         new License(createKey(105, 89, 49, 70, 75, 82, 74, 122, 85, 103)));
      pluginMap.put("com.ose.perf.ui",
         new License(createKey(65, 115, 77, 87, 65, 102, 90, 77, 90, 99)));
      pluginMap.put("com.ose.dbgserver",
         new License(createKey(103, 112, 120, 48, 118, 110, 51, 114, 70, 99)));
