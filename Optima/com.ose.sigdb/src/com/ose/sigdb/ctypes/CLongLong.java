...
/** This class represents the C long long type. */
public class CLongLong extends CIntType
{
   ...
   /**
    * Create the C longlong type (unsigned or signed).
    * 
    * @param _unsigned
    *           true if the type is unsigned.
    * @param _size
    *           the size of the long long in bytes.
    * @param _defaultEndian
    *           the default endian used by toString.
    */
   public CLongLong(boolean _unsigned, int _size, int _defaultEndian)
   {
