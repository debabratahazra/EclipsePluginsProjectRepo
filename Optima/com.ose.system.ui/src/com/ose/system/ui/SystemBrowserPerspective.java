...
public class SystemBrowserPerspective implements IPerspectiveFactory
{
   public void createInitialLayout(IPageLayout layout)
   {
      ...
      bottom.addView(SystemBrowserPlugin.LOAD_MODULE_VIEW_ID);
      bottom.addView(SystemBrowserPlugin.POOL_VIEW_ID);
      bottom.addView(SystemBrowserPlugin.HEAP_VIEW_ID);
      bottom.addView(SystemBrowserPlugin.BLOCK_VIEW_ID);
      bottom.addView(SystemBrowserPlugin.PROCESS_VIEW_ID);
