...
public class HeapBuffersPerActualSizeChart extends AbstractBarChart
{
   private BarSeries usedSeries;

   public HeapBuffersPerActualSizeChart()
   {
      super("Buffers / Actual Size",
            "The number of allocated heap buffers " +
            "per actual heap buffer size.",
   ...
   protected void setInput(Object[] input)
   {
      ...
      for (int i = 0; i < length; i++)
      {
         ...
         xLabels[i] = truncateString(Integer.toString(cd.getActualSize()));
   ...
   static class ChartDataComparator extends AbstractChartDataComparator
   {
      public int compare(Object o1, Object o2)
      {
         ...
         {
            return compareUnsignedInts(cd1.getActualSize(), cd2.getActualSize());
         }
      }
   }
}
