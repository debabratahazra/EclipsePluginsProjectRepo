...
public class HeapMemoryPerRequestedSizeChart extends AbstractBarChart
{
   private BarSeries usedSeries;
   private BarSeries slackSeries;

   public HeapMemoryPerRequestedSizeChart()
   {
      super("Bytes / Requested Size",
            "The amount of allocated and slack bytes per requested heap buffer size.",
   ...
   protected Chart createChart()
   {
      ...
      sdY.getSeriesPalette().getEntries().add(ColorDefinitionImpl.create(46, 197, 200));
