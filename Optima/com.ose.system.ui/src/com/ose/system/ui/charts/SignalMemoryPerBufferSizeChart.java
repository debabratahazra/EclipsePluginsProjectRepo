...
public class SignalMemoryPerBufferSizeChart extends AbstractBarChart
{
   private BarSeries usedSeries;
   private BarSeries slackSeries;
   private BarSeries freeSeries;

   public SignalMemoryPerBufferSizeChart()
   {
      super("Bytes / Actual Signal Buffer Size",
            "The amount of allocated, slack, and freed " +
            "bytes per actual signal buffer size.",
