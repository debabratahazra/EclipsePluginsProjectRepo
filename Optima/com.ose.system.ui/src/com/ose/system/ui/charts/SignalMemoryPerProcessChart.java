...
public class SignalMemoryPerProcessChart extends AbstractBarChart
{
   private BarSeries usedSeries;
   private BarSeries slackSeries;
   private BarSeries freeSeries;

   public SignalMemoryPerProcessChart()
   {
      super("Bytes / Process",
            "The amount of allocated, slack, and freed signal bytes per process.",
