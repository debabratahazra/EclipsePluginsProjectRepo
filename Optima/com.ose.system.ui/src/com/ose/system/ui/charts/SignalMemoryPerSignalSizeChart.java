...
public class SignalMemoryPerSignalSizeChart extends AbstractBarChart
{
   private BarSeries usedSeries;
   private BarSeries slackSeries;
   private BarSeries freeSeries;

   public SignalMemoryPerSignalSizeChart()
   {
      super("Bytes / Signal Size",
            "The amount of allocated, slack, and freed bytes per signal size.",
   ...
   protected Chart createChart()
   {
      ...
      sdY.getSeriesPalette().getEntries().add(ColorDefinitionImpl.create(216, 180, 181));
