...
public class SignalsPerSignalNumberChart extends AbstractBarChart
{
   private BarSeries usedSeries;
   private BarSeries freeSeries;

   public SignalsPerSignalNumberChart()
   {
      super("Signals / Signal Number",
            "The number of allocated and freed signals per signal number.",
