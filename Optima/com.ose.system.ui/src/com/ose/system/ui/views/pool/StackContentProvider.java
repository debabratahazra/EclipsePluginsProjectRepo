...
{
   private ExtendedStackInfo[] stacks;

   public void inputChanged(Viewer viewer, Object oldInput, Object newInput)
   {
      if (newInput instanceof ExtendedStackInfo[])
      {
         stacks = (ExtendedStackInfo[]) newInput;
      }
   }
   ...
   {
      return ((stacks != null) ? stacks : new ExtendedStackInfo[0]);
   }
}
