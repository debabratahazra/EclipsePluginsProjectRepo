...
/**
 * This class represents an alloc event from an OSE target. An alloc event is
 * reported when a signal, i.e. a pool buffer, is allocated by a process.
 *
 * @see com.ose.system.TargetEvent
 */
public class AllocEvent extends TargetEvent
{
   ...
   /**
    * Create a new alloc event object.
    *
    ...
    * @param from           the allocating process.
   ...
   /**
    * Create a new alloc event object for off-line usage.
    ...
    * @param euId           the execution unit.
    * @param fileName       the filename.
    * @return a new alloc event object for off-line usage.
    */
   public static AllocEvent getInstance(Object target,
                                        int tickLength,
                                        int reference,
                                        int tick,
                                        int ntick,
   ...
   /**
    * Return the process that allocated the signal.
    *
    * @return the process that allocated the signal.
    */
   ...
   /**
    * Return a string representation of this alloc event object.
    *
    * @return a string representation of this alloc event object.
