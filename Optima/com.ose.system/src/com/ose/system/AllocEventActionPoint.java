...
/**
 * This class represents an OSE alloc event action point. An alloc event action
 * point defines what kind of action should be taken when an alloc event occurs.
 *
 * @see com.ose.system.EventActionPoint
 * @see com.ose.system.AllocEvent
 */
public final class AllocEventActionPoint extends EventActionPoint
{
   /**
    * Create a new alloc event action point object.
    */
   public AllocEventActionPoint()
   {
      super();
   }
    ...
    */
   public AllocEventActionPoint(int state,
                                int fromScopeType,
                                int fromScopeId,
    ...
    */
   AllocEventActionPoint(int state,
                         int fromType,
                         int fromId,
                         int toType,
                         int toId,
