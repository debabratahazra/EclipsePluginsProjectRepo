...
/**
 * This class represents an OSE bind event action point. An bind event action
 * point defines what kind of action should be taken when a bind event occurs.
 *
 * @see com.ose.system.EventActionPoint
 * @see com.ose.system.BindEvent
 */
public final class BindEventActionPoint extends EventActionPoint
{
   /**
    * Create a new bind event action point object.
    */
   public BindEventActionPoint()
   {
      super();
   }
    ...
    */
   public BindEventActionPoint(int state,
                               int fromScopeType,
                               int fromScopeId,
    ...
    */
   BindEventActionPoint(int state,
                        int fromType,
                        int fromId,
                        int toType,
                        int toId,
