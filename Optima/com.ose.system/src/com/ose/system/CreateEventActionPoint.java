...
/**
 * This class represents an OSE create event action point. A create event action
 * point defines what kind of action should be taken when a create event occurs.
 *
 * @see com.ose.system.EventActionPoint
 * @see com.ose.system.CreateEvent
 */
public final class CreateEventActionPoint extends EventActionPoint
{
   /**
    * Create a new create event action point object.
    */
   public CreateEventActionPoint()
   {
      super();
   }
    ...
    */
   public CreateEventActionPoint(int state,
                                 int fromScopeType,
                                 int fromScopeId,
    ...
    */
   CreateEventActionPoint(int state,
                          int fromType,
                          int fromId,
                          int toType,
                          int toId,
