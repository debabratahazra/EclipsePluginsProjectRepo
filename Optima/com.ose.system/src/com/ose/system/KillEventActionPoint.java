...
/**
 * This class represents an OSE kill event action point. A kill event action
 * point defines what kind of action should be taken when a kill event occurs.
 *
 * @see com.ose.system.EventActionPoint
 * @see com.ose.system.KillEvent
 */
public final class KillEventActionPoint extends EventActionPoint
{
   /**
    * Create a new kill event action point object.
    */
   public KillEventActionPoint()
   {
      super();
   }
    ...
    */
   public KillEventActionPoint(int state,
                               int fromScopeType,
                               int fromScopeId,
    ...
    */
   KillEventActionPoint(int state,
                        int fromType,
                        int fromId,
                        int toType,
                        int toId,
