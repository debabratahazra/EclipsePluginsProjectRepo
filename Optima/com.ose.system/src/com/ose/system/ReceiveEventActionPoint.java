...
/**
 * This class represents an OSE receive event action point. A receive event
 * action point defines what kind of action should be taken when a receive event
 * occurs.
 *
 * @see com.ose.system.EventActionPoint
 * @see com.ose.system.ReceiveEvent
 */
public final class ReceiveEventActionPoint extends EventActionPoint
{
   ...
   /**
    * Create a new receive event action point object.
    */
   public ReceiveEventActionPoint()
   {
      super();
    ...
    * information will be included in receive events or not.
    ...
    */
   public ReceiveEventActionPoint(int state,
                                  int fromScopeType,
                                  int fromScopeId,
    ...
    */
   ReceiveEventActionPoint(int state,
                           int fromType,
                           int fromId,
                           int toType,
                           int toId,
   ...
   /**
    * Determine whether signal data will be included in receive events or not.
    * <p>
    * Only applicable if getAction() returns ACTION_NOTIFY, ACTION_INTERCEPT, or
    * ACTION_TRACE.
    *
    * @return true if signal data will be included in receive events, false
    * otherwise.
    */
   ...
   /**
    * Set whether signal data will be included in receive events or not.
    * <p>
    * Only applicable if getAction() returns ACTION_NOTIFY, ACTION_INTERCEPT, or
    * ACTION_TRACE.
    *
    * @param signalDataIncluded  true if signal data will be included in receive
