...
/**
 * This class represents a send event from an OSE target. A send event is
 * reported when a signal is sent by a process.
 *
 * @see com.ose.system.TargetEvent
 */
public class SendEvent extends TargetEvent
{
   ...
   /**
    * Create a new send event object.
    *
   ...
   /**
    * Create a new send event object for off-line usage.
    ...
    * available.
    * @return a new send event object for off-line usage.
    */
   public static SendEvent getInstance(Object target,
                                       int tickLength,
                                       int reference,
                                       int tick,
                                       int ntick,
   ...
   {
      SendEvent sendEvent = new SendEvent(target,
                                          tickLength,
                                          reference,
                                          tick,
                                          ntick,
                                          ...
                                          fileName,
                                          signalData);
      sendEvent.formattedSignalData = formattedSignalData;
      return sendEvent;
   }
   ...
   /**
    * Return the process that the signal is addressed to.
    *
    * @return the process that the signal is addressed to.
    */
   ...
   /**
    * Return a string representation of this send event object.
    *
    * @return a string representation of this send event object.
