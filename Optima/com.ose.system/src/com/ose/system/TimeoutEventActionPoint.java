...
/**
 * This class represents an OSE timeout event action point. A timeout event
 * action point defines what kind of action should be taken when a timeout
 * event occurs.
 *
 * @see com.ose.system.EventActionPoint
 * @see com.ose.system.TimeoutEvent
 */
public final class TimeoutEventActionPoint extends EventActionPoint
{
   /**
    * Create a new timeout event action point object.
    */
   public TimeoutEventActionPoint()
   {
      super();
   }
    ...
    */
   public TimeoutEventActionPoint(int state,
                                  int fromScopeType,
                                  int fromScopeId,
    ...
    */
   TimeoutEventActionPoint(int state,
                           int fromType,
                           int fromId,
                           int toType,
                           int toId,
