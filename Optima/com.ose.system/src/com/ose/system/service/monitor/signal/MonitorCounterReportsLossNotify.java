...
public class MonitorCounterReportsLossNotify extends Signal
{
   public static final int SIG_NO = 40792;

   public short euId;      // U16
   public int counterType; // U32
   public int reportsLost; // U32

   public MonitorCounterReportsLossNotify()
   {
      super(SIG_NO);
   }
