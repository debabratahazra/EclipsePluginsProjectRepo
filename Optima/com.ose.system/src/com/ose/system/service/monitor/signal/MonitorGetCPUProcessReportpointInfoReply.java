...
public class MonitorGetCPUProcessReportpointInfoReply extends Signal
{
   public static final int SIG_NO = 39267;
   ...
   public MonitorGetCPUProcessReportpointInfoReply()
   {
      super(SIG_NO);
   }
