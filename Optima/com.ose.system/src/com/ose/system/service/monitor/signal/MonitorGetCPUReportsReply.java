...
public class MonitorGetCPUReportsReply extends Signal
{
   public static final int SIG_NO = 39271;

   public int status;                 // U32
   public boolean enabled;            // U32
   public short euId;                 // U16
   public MonitorCPUReport[] reports; // MonitorCPUReport[]

   public MonitorGetCPUReportsReply()
   {
      super(SIG_NO);
   }
   ...
   protected void read(SignalInputStream in) throws IOException
   {
      ...
      reports = new MonitorCPUReport[reportsCount];
      for (int i = 0; i < reportsCount; i++)
      {
         MonitorCPUReport report = new MonitorCPUReport();
         report.tick = in.readS32();
         report.ntick = in.readS32();
         report.interval = in.readS32();
         report.sum = in.readS32();
         reports[i] = report;
      }
   }
