...
public class MonitorGetCounterReportsNotifyEnabledReply extends Signal
{
   public static final int SIG_NO = 40788;
   ...
   public MonitorGetCounterReportsNotifyEnabledReply()
   {
      super(SIG_NO);
   }
