...
public class MonitorGetSysParamReply extends Signal
{
   public static final int SIG_NO = 39061;

   public String name;  // char[]
   public String value; // char[]

   public MonitorGetSysParamReply()
   {
      super(SIG_NO);
   }
   ...
   protected void read(SignalInputStream in) throws IOException
   {
      ...
      in.readS32(); // Unused U32 valueOffset
      name = in.readString();
      value = in.readString();
   }
