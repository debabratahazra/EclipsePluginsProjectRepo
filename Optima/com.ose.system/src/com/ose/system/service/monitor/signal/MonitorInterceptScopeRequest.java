...
public class MonitorInterceptScopeRequest extends Signal
{
   public static final int SIG_NO = 39130;

   public int scopeType;     // U32
   public int scopeId;       // U32
   public MonitorTag[] tags; // MonitorTag[]

   public MonitorInterceptScopeRequest()
   {
      super(SIG_NO);
   }

   public MonitorInterceptScopeRequest(int scopeType,
                                       int scopeId,
                                       MonitorTag[] tags)
   {
      super(SIG_NO);
