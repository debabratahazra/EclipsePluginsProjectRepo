...
public class MonitorSetCPUProcessReportpointRequest extends Signal
{
   public static final int SIG_NO = 39262;

   public int scopeType;     // U32
   public int scopeId;       // U32
   public MonitorTag[] tags; // MonitorTag[]

   public MonitorSetCPUProcessReportpointRequest()
   {
      super(SIG_NO);
   }

   public MonitorSetCPUProcessReportpointRequest(int scopeType,
                                                 int scopeId,
                                                 MonitorTag[] tags)
   {
      super(SIG_NO);
