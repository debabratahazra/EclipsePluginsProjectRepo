...
public class MonitorSetInterceptScopeRequest extends Signal
{
   public static final int SIG_NO = 39242;

   public int scopeType;     // U32
   public int scopeId;       // U32
   public MonitorTag[] tags; // MonitorTag[]

   public MonitorSetInterceptScopeRequest()
   {
      super(SIG_NO);
   }

   public MonitorSetInterceptScopeRequest(int scopeType,
                                          int scopeId,
                                          MonitorTag[] tags)
   {
      super(SIG_NO);
