...
public class MonitorSetScopeRequest extends Signal
{
   public static final int SIG_NO = 39240;

   public int scopeType;     // U32
   public int scopeId;       // U32
   public MonitorTag[] tags; // MonitorTag[]

   public MonitorSetScopeRequest()
   {
      super(SIG_NO);
   }

   public MonitorSetScopeRequest(int scopeType, int scopeId, MonitorTag[] tags)
   {
      super(SIG_NO);
