...
public class PmCreateProgramReply extends Signal
{
   public static final int SIG_NO = 36223;

   public int status;            // U32
   public int domain;            // U32
   public String install_handle; // char[32]
   public int progpid;           // U32
   public int main_bid;          // U32

   public PmCreateProgramReply()
   {
      super(SIG_NO);
   }
