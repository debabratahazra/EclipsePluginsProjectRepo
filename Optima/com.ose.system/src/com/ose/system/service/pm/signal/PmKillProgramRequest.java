...
public class PmKillProgramRequest extends Signal
{
   public static final int SIG_NO = 36226;

   public int progpid; // U32

   public PmKillProgramRequest()
   {
      super(SIG_NO);
   }

   public PmKillProgramRequest(int progpid)
   {
      super(SIG_NO);
