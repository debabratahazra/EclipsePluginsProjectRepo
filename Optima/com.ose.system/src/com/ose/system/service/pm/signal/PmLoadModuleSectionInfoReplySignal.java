...
public abstract class PmLoadModuleSectionInfoReplySignal extends Signal
{
   public int status;                 // U32
   public String install_handle;      // char[32]
   public int section_interval_start; // U32
   public int section_interval_end;   // U32
   public LoadModuleSectionInfo[] sections; // PmLoadModuleSectionInfo[]

   protected PmLoadModuleSectionInfoReplySignal(int sigNo)
   {
      super(sigNo);
   }
