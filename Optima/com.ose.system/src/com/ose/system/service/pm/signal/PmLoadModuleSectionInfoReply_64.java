...
public class PmLoadModuleSectionInfoReply_64 extends PmLoadModuleSectionInfoReplySignal
{
   public static final int SIG_NO = 36319;

   public PmLoadModuleSectionInfoReply_64()
   {
      super(SIG_NO);
   }
   ...
   protected void read(SignalInputStream in) throws IOException
   {
      ...
      if (num_sections > 0)
      {
         ...
         for (int i = 0; i < num_sections; i++)
         {
            ...
            sectionInfo.section_base = in.readS64();
            sectionInfo.section_size = in.readS64();
   ...
   protected void write(SignalOutputStream out) throws IOException
   {
      ...
      for (int i = 0; i < num_sections; i++)
      {
         ...
         out.writeS64(sectionInfo.section_base);
         out.writeS64(sectionInfo.section_size);
