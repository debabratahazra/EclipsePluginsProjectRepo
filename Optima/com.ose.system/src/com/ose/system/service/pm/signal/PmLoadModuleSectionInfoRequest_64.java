...
public class PmLoadModuleSectionInfoRequest_64 extends 
   PmLoadModuleSectionInfoRequestSignal
{
   public static final int SIG_NO = 36318;

   public PmLoadModuleSectionInfoRequest_64()
   {
      super(SIG_NO);
   }

   public PmLoadModuleSectionInfoRequest_64(String install_handle,
