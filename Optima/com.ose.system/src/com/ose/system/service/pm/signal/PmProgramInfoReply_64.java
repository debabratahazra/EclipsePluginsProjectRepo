...
public class PmProgramInfoReply_64 extends PmProgramInfoReplySignal
{
   public static final int SIG_NO = 36335;

   public PmProgramInfoReply_64()
   {
      super(SIG_NO);
   }
   ...
   protected void read(SignalInputStream in) throws IOException
   {
      ...
      pool_base = in.readS64();
      pool_size = in.readS64();
      uid = in.readS32();
      state = in.readS32();
      ...
      if (getSigSize() > 72)
      {
         ...
         sig_pool_base = in.readS64();
         sig_pool_size = in.readS64();
         heap = in.readS32();
      }
   }
   ...
   protected void write(SignalOutputStream out) throws IOException
   {
      ...
      out.writeS64(pool_base);
      out.writeS64(pool_size);
      out.writeS32(uid);
      out.writeS32(state);
      // Only available in OSE 5.2 and later:
      if (extended_info)
      {
         ...
         out.writeS64(sig_pool_base);
         out.writeS64(sig_pool_size);
         out.writeS32(heap);
      }
   }
}
