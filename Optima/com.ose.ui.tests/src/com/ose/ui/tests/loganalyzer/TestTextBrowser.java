...
public class TestTextBrowser extends AbstractLABaseTest
{
   private static final String PROJECT_NAME = "Project_TextBrowser";
   ...
   public void testTextBrowser() throws Exception
   {
      IUIContext ui = getUI();
