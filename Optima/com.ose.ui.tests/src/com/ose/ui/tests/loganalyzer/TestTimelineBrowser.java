...
public class TestTimelineBrowser extends AbstractLABaseTest
{
   private static final String PROJECT_NAME = "Project_Timeline";
   ...
   public void testTimelineBrowser() throws Exception
   {
      IUIContext ui = getUI();
