...
public class TestCPUPriority extends AbstractTargetBaseTest
{
   private static final String PROJECT_NAME = "Profiler_Project_Prio";
   ...
   public void testSessionCreate() throws Exception
   {
      ...
      // Set Environment variable of a Block
      ui.contextClick(
   ...
   public void testRemoveTarget() throws Exception
   {
      ...
      ui.click(new ComboItemLocator("CPU Usage / Priority",
   ...
   public void testPramNotAcceptedHost() throws Exception
   {
      IUIContext ui = getUI();
