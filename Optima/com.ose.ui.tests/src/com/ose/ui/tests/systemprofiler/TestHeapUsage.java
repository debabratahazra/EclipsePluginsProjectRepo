...
public class TestHeapUsage extends AbstractTargetBaseTest
{
   private static final String PROJECT_NAME = "Profiler_Project_Heap";
   ...
   public void testHeapSaveAndOpenXML() throws Exception
   {
      IUIContext ui = getUI();
      ...
      // Add target in system rofiler view
      addTarget(ui);
   ...
   public void testHeapSaveAndOpenPMD() throws Exception
   {
      IUIContext ui = getUI();
   ...
   public void testHeapDisableProf() throws Exception
   {
      IUIContext ui = getUI();
   ...
   public void testHeapRemoveTarget() throws Exception
   {
      IUIContext ui = getUI();
      ...
      ui.click(new ComboItemLocator("Turnover Heap Usage / Process", new SWTWidgetLocator(
      ...
      ui.assertThat(new NamedWidgetLocator("Processes per Report:").hasText("8"));
      ...
      // Remove Target
      ui.click(new CTabItemLocator("System Profiler"));
      ui.contextClick(new TableItemLocator(UIUtils.getText(item),
   ...
   public void testHeapPMDMonitorReports() throws Exception
   {
      IUIContext ui = getUI();
   ...
   public void testHeapBrowsePMD() throws Exception
   {
      IUIContext ui = getUI();
   ...
   public void testHeapParamNotAcceptedHost() throws Exception
   {
      IUIContext ui = getUI();

      // Try to add target with different parameters
      ui.contextClick(new TreeItemLocator(getTargetRegex(), new ViewLocator(
            SystemBrowserPlugin.SYSTEM_VIEW_ID)), "Show in System Profiler");
      ui.wait(new ShellShowingCondition("Target and Profiling Parameters"));
      ui.wait(new ShellDisposedCondition("Finding Targets"));
   ...
   public void testHeapParamNotAcceptedTarget() throws Exception
   {
      IUIContext ui = getUI();
   ...
   public void testHeapRefuseSession() throws Exception
   {
      IUIContext ui = getUI();
