...
public class LineInfoLocation {
	...
	public LineInfoLocation(boolean error) {
		this.error=error;
	}

	public String lineInfoLocation() {
		...
		if (resource != null) 
        {
            ...
            //Project is Open.........
            		...
            		if(fileDebug.exists() && !fileRelease.exists()){
            			return (projectPath + "\\Debug\\.LineInfo.txt");
            		}
            		
            		//Only Release Mode......
            		else if(fileRelease.exists() && !fileDebug.exists()){
            			return (projectPath + "\\Release\\.LineInfo.txt");            			
            		}
