...
public class SourceFileLocation  {
	...
	private static final String C_PROJECTS_VIEW = "org.eclipse.cdt.ui.CView";
	IResource resource = null;
	IContainer container = null;
	boolean error=true;
	
	public SourceFileLocation(boolean error) {
		this.error=error;
	}
	...
	public String sourceFileLocation() {
		...
		if (resource != null) 
        {
            ...
            //Project is Open.........
            		...
            		String dsmFileLocationDebug = new String(projectPath +  
            				"\\" + ".sourceFile.txt");            		      
            		String dsmFileLocationRelease = new String(projectPath + 
            				"\\" + "..sourceFile.txt");             	      
            		...
            		if(fileDebug.exists() && !fileRelease.exists()){
            			return (projectPath + "\\.sourceFile.txt");
            		}
		...
		ConsoleDisplayMgr.getDefault().println("BUILD ERROR OCCURRED. RE-BUILD THE PROJECT.", 2);
		return null;
	}	
