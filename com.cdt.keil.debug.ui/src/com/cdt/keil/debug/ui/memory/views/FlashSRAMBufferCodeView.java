...
public class FlashSRAMBufferCodeView extends ViewPart {
	...
	public FlashSRAMBufferCodeView() {}
	...
	public void createPartControl(Composite parent) {
		...
		buttonRefresh.setToolTipText("Refresh Flash SRAM Buffer Code Memory View");
		buttonRefresh.addMouseListener(new org.eclipse.swt.events.MouseListener() {
			...
			public void mouseUp(org.eclipse.swt.events.MouseEvent e) {				
				//Update Flash SRAM Buffer Code Memory view in Simulator SDK. 
				short [] addressValue = getAddress(textbox.getText());
				if (addressValue==null) return;	
					Packet_ACK=IdebugInterface.readFlashSRAMBufferCodeMemory(addressValue);					
					Packet_ACK[1]++;
		...
		buttonClose.setToolTipText("Close Flash SRAM Buffer Code Memory View");
		buttonClose.addMouseListener(new org.eclipse.swt.events.MouseListener() {
			public void mouseUp(org.eclipse.swt.events.MouseEvent e) {				
				...
				findView("com.cdt.keil.debug.ui.FlashSRAMBufferCodeView"));
			}
			public void mouseDoubleClick(org.eclipse.swt.events.MouseEvent e) {
			}
			public void mouseDown(org.eclipse.swt.events.MouseEvent e) {
