...
public class SRAMDataMemoryView extends ViewPart {
	...
	public static final int ROW=1024;

	public SRAMDataMemoryView() {		
	}
	...
	public void createPartControl(Composite parent) {
		...
		buttonRefresh.setToolTipText("Refresh SRAM Data Memory View");
		buttonRefresh.addMouseListener(new org.eclipse.swt.events.MouseListener() {
			...
			public void mouseUp(org.eclipse.swt.events.MouseEvent e) {				
				...
				if (addressValue==null) return;						
					Packet_ACK=IdebugInterface.readSRAMDataMemory(addressValue);					
					Packet_ACK[1]++;
		...
		buttonClose.setToolTipText("Close SRAM Data Memory View");
		buttonClose.addMouseListener(new org.eclipse.swt.events.MouseListener() {
			public void mouseUp(org.eclipse.swt.events.MouseEvent e) {				
				...
				findView("com.cdt.keil.debug.ui.SRAMDataMemoryView"));
			}
			public void mouseDoubleClick(org.eclipse.swt.events.MouseEvent e) {
			}
			public void mouseDown(org.eclipse.swt.events.MouseEvent e) {
