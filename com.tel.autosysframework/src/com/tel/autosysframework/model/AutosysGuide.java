...
implements Serializable
{
	 ...
	 * 							a vertical ruler)
	 */
	public AutosysGuide(boolean isHorizontal) {
	 ...
	 */
	/**
	 * Attaches the given part along the given edge to this guide.  The AutosysSubpart is also
	 ...
	 */
	public void attachPart(AutosysSubpart part, int alignment) {
		if (getMap().containsKey(part) && getAlignment(part) == alignment)
			return;

		getMap().put(part, new Integer(alignment));
		AutosysGuide parent = isHorizontal() ? part.getHorizontalGuide() : part.getVerticalGuide();
	...
	/**
	 * Detaches the given part from this guide.  The AutosysSubpart is also updated to reflect
	 * this change.
	 * 
	 * @param	part	the part that is to be detached from this guide
	 */
	public void detachPart(AutosysSubpart part) {
	 ...
	 * {@link com.telxsi.autosysframework.editpolicy.examples.Autosysdesigner.edit.AutosysXYLayoutEditPolicy AutosysXYLayoutEditPolicy}
	 ...
	 * @see		com.telxsi.autosysframework.editpolicy.examples.Autosysdesigner.edit.AutosysXYLayoutEditPolicy#createChangeConstraintCommand(ChangeBoundsRequest, EditPart, Object)
	 */
	public int getAlignment(AutosysSubpart part) {
	 ...
	 * 			the keys are AutosysSubparts and values are Integers
	 */
	public Map getMap() {
		if (map == null) {
			map = new Hashtable();
